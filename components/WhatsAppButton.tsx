...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <div className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-200">
        <svg
