...
// Consolidar trailing slashes — antes de todos os redirects específicos
      ...
      { source: '/blog/jaleco-dentista-o-que-usar', destination: '/blog/guia-jaleco-para-dentista-modelos-cores-como-escolher', permanent: true },
      { source: '/blog/jaleco-dentista-estilo-praticidade-consultorio-2', destination: '/blog/guia-jaleco-para-dentista-modelos-cores-como-escolher', permanent: true },
    ...
    // ── 404s reais — blog posts deletados/renomeados (03/05/2026) ──
    { source: '/blog/jaleco-dentista-modelos-cores-como-escolher', destination: '/blog/guia-jaleco-para-dentista-modelos-cores-como-escolher', permanent: true },
    { source: '/blog/jaleco-para-dentistas', destination: '/blog/guia-jaleco-para-dentista-modelos-cores-como-escolher', permanent: true },
    { source: '/blog/jaleco-para-dentistas-2', destination: '/blog/guia-jaleco-para-dentista-modelos-cores-como-escolher', permanent: true },
    { source: '/blog/jaleco-para-dentista-estilo-praticidade-consultorio', destination: '/blog/guia-jaleco-para-dentista-modelos-cores-como-escolher', permanent: true },
    { source: '/blog/jaleco-fisioterapeuta-conforto-longas-jornadas-2', destination: '/blog/jaleco-para-fisioterapeuta-guia', permanent: true },
    { source: '/blog/jaleco-massagista-mobilidade-higiene-drenagem', destination: '/blog/jaleco-para-medica-guia-completo', permanent: true },
    { source: '/blog/jaleco-enfermagem-o-que-considerar-comprar', destination: '/blog/jaleco-para-enfermeira-regras-cofen', permanent: true },
    { source: '/blog/como-lavar-e-conservar-seu-jaleco-profissional', destination: '/blog/como-lavar-jaleco-profissional-guia-completo', permanent: true },
    { source: '/blog/como-escolher-jaleco-ideal-especialidade-medica', destination: '/blog/como-escolher-jaleco-feminino-guia-profissionais', permanent: true },
    { source: '/blog/guia-completo-tamanhos-jaleco-como-medir-corretamente', destination: '/blog/jaleco-feminino-tamanho-certo-como-medir', permanent: true },
    { source: '/blog/jaleco-feminino-tendencias-funcionalidade-saude', destination: '/blog/jaleco-slim-feminino', permanent: true },
    { source: '/blog/jaleco-feminino-tendencias-funcionalidade-saude-2', destination: '/blog/jaleco-slim-feminino', permanent: true },
    // ── Dia das Mães — páginas sazonais → profissão correspondente ──
    { source: '/dia-das-maes/farmacia', destination: '/jaleco-farmaceutica', permanent: true },
    { source: '/dia-das-maes/estetica', destination: '/jaleco-esteticista', permanent: true },
    { source: '/dia-das-maes/veterinaria', destination: '/jaleco-veterinaria', permanent: true },
    { source: '/dia-das-maes/:path*', destination: '/categoria/jalecos-femininos', permanent: true },
    // ── Produtos .html (URLs antigas do WooCommerce/WordPress) ──
    { source: '/jaleco-slim-duquesa-feminino-varias-cores-jaleca.html', destination: '/produto/jaleco-slim-duquesa-feminino-jaleca', permanent: true },
    { source: '/jaleco-padrao-aluno-feminino-de-botao-varias-cores-jaleca.html', destination: '/produto/jaleco-padrao-aluno-feminino-jaleca', permanent: true },
    { source: '/jaleco-padrao-aluno-masculino-de-botao-varias-cores-jaleca.html', destination: '/produto/jaleco-padrao-aluno-masculino-jaleca', permanent: true },
    { source: '/conjunto-pijama-cirurgico-scrub-feminino-varias-cores-jaleca.html', destination: '/produto/conjunto-scrub-feminino-jaleca', permanent: true },
    { source: '/conjunto-pijama-cirurgico-scrub-masculino-varias-cores-jaleca.html', destination: '/produto/conjunto-scrub-masculino-jaleca', permanent: true },
    { source: '/conjunto-pijama-cirurgico-princesa-scrub-feminino-varias-cores-jaleca.html', destination: '/produto/conjunto-princesa-nobre-feminino-jaleca', permanent: true },
    { source: '/conjunto-dolma-cozinheiro-de-ziper-e-avental-saia-slim-jaleca.html', destination: '/produto/conjunto-dolma-cozinheiro-feminino-jaleca', permanent: true },
    { source: '/conjunto-dolma-cozinheiro-masculino-de-ziper-e-avental-saia-slim-jaleca.html', destination: '/produto/conjunto-dolma-cozinheiro-masculino-jaleca', permanent: true },
    { source: '/conjunto-jeane-andrade-feminino-varias-cores-jaleca.html', destination: '/produto/jaleco-slim-princesa-laise-feminino-jaleca', permanent: true },
    { source: '/jaleco-slim-moratty-feminino-ziper-central-jaleca.html', destination: '/produto/jaleco-slim-moratty-feminino-jaleca', permanent: true },
    { source: '/jaleco-slim-recortes-masculino-varias-cores-jaleca.html', destination: '/produto/jaleco-slim-recortes-masculino-jaleca', permanent: true },
    { source: '/jaleco-slim-masculino-de-ziper-central-varias-cores-jaleca.html', destination: '/produto/jaleco-slim-moratty-masculino-jaleca', permanent: true },
    { source: '/jaleco-laise-jeane-andrade-feminino-varias-cores-jaleca.html', destination: '/produto/jaleco-slim-princesa-laise-feminino-jaleca', permanent: true },
    // ── Produtos antigos com trailing slash ──
    { source: '/produto/jaleco-laise-jeane-andrade-feminino-varias-cores-jaleca/', destination: '/produto/jaleco-slim-princesa-laise-feminino-jaleca', permanent: true },
    { source: '/produto/produto-de-teste-bling/', destination: '/produtos', permanent: true },
    { source: '/produto/produto-de-teste-bling', destination: '/produtos', permanent: true },
    // ── Outras páginas 404 ──
    { source: '/frete', destination: '/faq', permanent: true },
    { source: '/frete/', destination: '/faq', permanent: true },
    ...
    return [
      {
        source: "/(.*)",
        headers: [
          { key: "Content-Security-Policy", value: "default-src 'self'; base-uri 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://embed.tawk.to https://www.gstatic.com https://googleads.g.doubleclick.net https://bat.bing.net https://bat.bing.com https://www.clarity.ms https://*.clarity.ms; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://wp.jaleca.com.br https://lh3.googleusercontent.com https://www.facebook.com https:; connect-src 'self' https://wp.jaleca.com.br https://www.google-analytics.com https://www.googletagmanager.com https://connect.facebook.net https://api.brevo.com https://api.pagar.me https://www.google.com https://googleads.g.doubleclick.net https://www.googleadservices.com https://conversionsapigateway.com https://*.conversionsapigateway.com https://*.a.run.app https://bat.bing.net https://bat.bing.com https://www.clarity.ms https://*.clarity.ms; worker-src 'self' blob:; frame-src https://www.google.com https://bid.g.doubleclick.net; object-src 'none';" },
