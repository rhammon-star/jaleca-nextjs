...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/:path*', has: [{ type: 'host', value: 'jalecomedico.com.br' }], destination: 'https://jaleca.com.br/jaleco-para-medico', permanent: true },
