    ...
    return [
      {
        source: "/(.*)",
        headers: [
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://embed.tawk.to https://t.contentsquare.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://wp.jaleca.com.br https://lh3.googleusercontent.com https://www.facebook.com https://og:image https:; connect-src 'self' https://wp.jaleca.com.br https://www.google-analytics.com https://www.googletagmanager.com https://connect.facebook.net https://api.brevo.com https://api.pagar.me https://t.contentsquare.net; frame-src 'none'; object-src 'none';" },
