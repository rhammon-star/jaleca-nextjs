...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Existe alguma regulamentação específica sobre o jaleco para esteticistas?", acceptedAnswer: { '@type': 'Answer', text: "Não há uma regulamentação de conselho profissional como nas áreas médicas, mas o uso do jaleco é fundamental para higiene e padronização visual. Foco em tecidos de fácil limpeza e desinfecção." } },
    { '@type': 'Question', name: "Qual o melhor tecido para um jaleco de esteticista, que combine beleza e praticidade?", acceptedAnswer: { '@type': 'Answer', text: "Recomendamos tecidos como gabardine, microfibra ou sarja leve. São resistentes a manchas, secam rapidamente, amassam pouco e proporcionam um visual sempre impecável e confortável." } },
    { '@type': 'Question', name: "Posso usar cores vibrantes ou diferentes do branco para o jaleco de esteticista?", acceptedAnswer: { '@type': 'Answer', text: "Sim! Na estética, há mais liberdade para cores. Oferecemos uma vasta paleta, incluindo tons pastéis, coloridos e até estampados, para que seu jaleco reflita o estilo da sua clínica." } },
    { '@type': 'Question', name: "Qual o corte ideal para um jaleco de esteticista, pensando em estilo e mobilidade?", acceptedAnswer: { '@type': 'Answer', text: "Nossos cortes são modernos e variados: desde o acinturado que valoriza a silhueta até modelos mais soltos, garantindo conforto e liberdade de movimentos para a execução dos procedimentos." } },
    { '@type': 'Question', name: "É possível personalizar o jaleco de esteticista com meu nome e o logo da clínica?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos o serviço de bordado personalizado para seu nome e o logo da sua clínica ou salão. É uma excelente forma de reforçar a sua marca e profissionalismo." } },
    { '@type': 'Question', name: "Quais as melhores dicas de lavagem para manter o jaleco de esteticista sempre novo e limpo?", acceptedAnswer: { '@type': 'Answer', text: "Lave em água fria ou morna, com sabão neutro e evite misturar cores para não manchar. Seque à sombra e passe a ferro em temperatura média para preservar a beleza do tecido." } },
    { '@type': 'Question', name: "Qual a durabilidade de um jaleco de esteticista de boa qualidade com uso frequente?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos são confeccionados com tecidos e costuras de alta durabilidade, pensados para resistir ao uso diário e às múltiplas lavagens, mantendo a aparência profissional por mais tempo." } },
    { '@type': 'Question', name: "Como escolher o tamanho certo do jaleco de esteticista para um caimento perfeito?", acceptedAnswer: { '@type': 'Answer', text: "Consulte nossa tabela de medidas detalhada e compare com as suas. É essencial para garantir um jaleco confortável que não atrapalhe seus movimentos e valorize sua imagem." } },
    { '@type': 'Question', name: "Há diferentes comprimentos de jalecos para esteticistas?", acceptedAnswer: { '@type': 'Answer', text: "Sim, além do comprimento tradicional, que vai até a altura do quadril ou coxa, temos modelos mais curtos ou em estilo blazer, adequados para um visual mais fashion e prático na estética." } },
    { '@type': 'Question', name: "Estão disponíveis opções de manga diferentes para jalecos de esteticista?", acceptedAnswer: { '@type': 'Answer', text: "Temos modelos com manga longa, 3/4 e manga curta, para atender às suas necessidades e preferências. A escolha da manga pode variar conforme o tipo de procedimento e o conforto térmico." } },
    { '@type': 'Question', name: "Quantos bolsos um jaleco de esteticista costuma ter e quais são seus usos?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos geralmente possuem dois bolsos frontais inferiores, ideais para guardar itens como espátulas, lápis de maquiagem ou pequenos instrumentos de trabalho de forma acessível." } },
    { '@type': 'Question', name: "Qual o estilo dos jalecos para esteticistas para um visual moderno e elegante?", acceptedAnswer: { '@type': 'Answer', text: "Priorizamos designs que unem funcionalidade e as últimas tendências da moda. Modelos acinturados, com detalhes em zíper ou botões diferenciados, para um look sofisticado e atual." } },
    { '@type': 'Question', name: "O que diferencia um jaleco para esteticista de um jaleco de um profissional da saúde tradicional?", acceptedAnswer: { '@type': 'Answer', text: "O jaleco de esteticista pode ser mais focado em design, cores e tecidos que ofereçam mais conforto e caimento, enquanto o profissional de saúde tradicional prioriza a esterilidade e proteção." } },
    { '@type': 'Question', name: "Posso comprar jalecos para toda a minha equipe de esteticistas com desconto?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos condições especiais e descontos progressivos para pedidos em grande volume, perfeitos para padronizar sua equipe com qualidade e estilo. Entre em contato para um orçamento." } },
    { '@type': 'Question', name: "Qual o preço médio de um jaleco de esteticista com estilo e personalização?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos de esteticista têm preços a partir de R$ 115,00, variando conforme o design, tecido e personalizações desejadas. Temos opções para todos os orçamentos." } },
    { '@type': 'Question', name: "Qual o prazo de entrega para jalecos de esteticista personalizados com logo e nome?", acceptedAnswer: { '@type': 'Answer', text: "O prazo de entrega para peças personalizadas é de 7 a 18 dias úteis, considerando o tempo de produção e o frete. Você receberá o código de rastreio para acompanhar seu pedido." } },
    { '@type': 'Question', name: "Como funciona a política de troca ou devolução se o jaleco de esteticista não servir?", acceptedAnswer: { '@type': 'Answer', text: "Aceitamos trocas em até 7 dias corridos após o recebimento, desde que o produto esteja sem uso e em perfeitas condições. Para itens personalizados, aplicam-se condições especiais." } },
    { '@type': 'Question', name: "Há ofertas de frete grátis para jalecos de esteticista em alguma compra?", acceptedAnswer: { '@type': 'Answer', text: "Sim, frequentemente oferecemos promoções de frete grátis para compras acima de um determinado valor ou em períodos específicos. Fique atenta às novidades em nosso site." } },
    { '@type': 'Question', name: "Os jalecos para esteticistas possuem garantia contra defeitos de fabricação?", acceptedAnswer: { '@type': 'Answer', text: "Absolutamente. Todos os nossos produtos possuem garantia de 60 dias contra defeitos de fabricação, assegurando sua total confiança na qualidade e durabilidade de nossos jalecos." } },
    { '@type': 'Question', name: "Os tecidos dos jalecos de esteticista são resistentes a manchas de produtos de beleza?", acceptedAnswer: { '@type': 'Answer', text: "Nossos tecidos, como o gabardine, são escolhidos pela sua resistência a manchas e facilidade de limpeza. Respingos acidentais podem ser removidos com facilidade, mantendo o jaleco impecável." } },
  ],
}
...
const schemaArticle = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'Jaleco para Esteticista: Tecido Premium, Caimento Perfeito',
  description: 'Guia completo do jaleco para esteticista: tecido premium, caimento perfeito, modelo Slim vs Profissional e custo-benefício.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Esteticista', item: 'https://jaleca.com.br/jaleco-esteticista' },
  ],
}
...
async function getJalecos(): Promise<WooProduct[]> {
  try {
    ...
    // Filtra por profissão esteticista
    const slugs = PROFESSION_PRODUCT_SLUGS['esteticista'] ?? []
...
export default async function JalecoEsteticistaPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    getJalecos(),
    getCachedBlogPosts('jaleco'),
    getGooglePlaceData(),
    getCachedHeroImage(getHeroImageSlug('esteticista') ?? ''),
  ])
  ...
  return (
    <>
      ...
      {(() => { const s = buildHowToSchema('jaleco-esteticista', 'https://jaleca.com.br/jaleco-esteticista'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const s = buildOccupationSchema('jaleco-esteticista', 'https://jaleca.com.br/jaleco-esteticista'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const s = buildItemListSchema(produtos, 'https://jaleca.com.br/jaleco-esteticista', "Jalecos para esteticista"); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const arr = buildProductListSchema(produtos, 'https://jaleca.com.br/jaleco-esteticista'); return arr ? arr.map((s, i) => <script key={'p'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      {(() => { const arr = buildReviewSchema(placeData?.reviews, 'https://jaleca.com.br/jaleco-esteticista', "Jaleco para esteticista", produtos); return arr ? arr.map((s, i) => <script key={'r'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        <div style={{ background: '#f9f7f4', borderBottom: '1px solid #e5e0d8', padding: '0.85rem clamp(1.5rem,5vw,4rem)' }}>
          <ol className="flex items-center gap-2 max-w-[1200px] mx-auto" style={{ listStyle: 'none' }}>
            {[
              ...
              { label: 'Para Esteticista', href: null },
            ].map((crumb, i, arr) => (
        ...
        {produtos.length > 0 && (
          <section id="produtos" className="px-4 py-12 lg:px-16 lg:py-20" style={{ background: '#f9f7f4', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
            <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
              <div className="mb-10">
                <div>
                  <div style={{ fontSize: '0.7rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#c8c4bc', marginBottom: '0.75rem' }}>Coleção estética</div>
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Jalecos para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Esteticistas</em>
                  </h2>
                </div>
                </div>
              ...
              <div className="flex justify-center mt-8">
                <Link href={getVerMaisUrl('esteticista')} style={{ display: 'inline-flex', padding: '0.9rem 2rem', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a', color: '#1a1a1a' }}>
                  Ver mais →
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 lg:gap-24" style={{ gap: 'clamp(3rem,6vw,6rem)', alignItems: 'start' }}>
              ...
              <article>
                {[
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Jaleco de esteticista aguenta muita lavagem e mancha. Precisa ser confortável por horas.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  {
                    id: 'cores',
                    title: 'Jaleco branco ou colorido: o que o CFERES diz',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O branco é o clássico, claro. Mas o CFERES não restringe cores.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  {
                    id: 'cro',
                    title: 'Normas do CFERES sobre vestimenta profissional',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O CFERES, junto com a ANVISA, exige: use o jaleco só no trabalho. Nunca em transporte ou fora da clínica. A peça precisa estar sempre limpa e em bom estado.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre jaleco<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>para esteticista</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
