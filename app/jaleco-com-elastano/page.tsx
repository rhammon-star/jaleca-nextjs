        ...
        <section style={{ background: '#f9f7f4', padding: 'clamp(3rem,8vw,6rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
            <h1 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2.4rem,5.5vw,4.2rem)', fontWeight: 400, lineHeight: 1.1, color: '#1a1a1a', marginBottom: '1.5rem' }}>
              Jaleco com elastano:<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>movimento sem trava</em>
            </h1>
            <p style={{ fontSize: '1rem', color: '#6b6b6b', maxWidth: 620, margin: '0 auto 2.5rem', lineHeight: 1.8 }}>
              4-6% de elastano no gabardine. Suficiente para acompanhar palpação, RCP, exodontia e jornada de 12h. Sem rigidez, sem amasso, sem perder estrutura.
            </p>
            <div className="flex gap-4 flex-wrap justify-center">
              <Link href="/jaleco-feminino" style={{ padding: '0.9rem 2rem', background: '#1a1a1a', color: '#fff', fontSize: '0.78rem', letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none' }}>Ver feminino</Link>
              <Link href="/jaleco-masculino" style={{ padding: '0.9rem 2rem', background: 'transparent', color: '#1a1a1a', fontSize: '0.78rem', letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a' }}>Ver masculino</Link>
            </div>
          </div>
        </section>
