...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-veterinario' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-veterinario',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Veterinário', item: 'https://jaleca.com.br/jaleco-para-veterinario' },
  ],
}
