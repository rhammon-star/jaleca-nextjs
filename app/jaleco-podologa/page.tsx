...
export const metadata: Metadata = {
  title: { absolute: 'Jaleco de Podóloga Slim — Feminino e Masculino na Jaleca' },
  description: 'Nota 4,9 no Google. Jaleco com elastano para podólogas — branco, preto e colorido, PP ao G3. Frete grátis Sudeste acima de R$499. Troca em 7 dias.',
  alternates: { canonical: 'https://jaleca.com.br/jaleco-podologa' },
  openGraph: {
    title: 'Jaleco para Podóloga — Slim, Branco e Colorido — Jaleca',
    description: 'Nota 4,9 no Google. Jaleco para podólogas com elastano, modelagem slim, PP ao G3. Frete grátis Sudeste acima de R$499.',
  ...
  twitter: {
    ...
    title: 'Jaleco para Podóloga — Tecido Premium, Caimento Perfeito — Jaleca',
    description: 'Jaleco premium para podólogas. Elastano, caimento perfeito, do PP ao G3. Frete grátis Sudeste.',
...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "É obrigatório bordar algum registro no jaleco feminino de podóloga?", acceptedAnswer: { '@type': 'Answer', text: "Não há uma exigência de conselho para o bordado de registro em jalecos de podólogas. No entanto, bordar seu nome e 'Podóloga' confere um toque profissional e de confiança. Oferecemos este serviço." } },
    { '@type': 'Question', name: "Qual o tecido mais adequado para um jaleco de podóloga que busca conforto e elegância?", acceptedAnswer: { '@type': 'Answer', text: "Recomendamos tecidos como gabardine com elastano ou microfibra, que oferecem excelente caimento, são maleáveis, de fácil manutenção e muito confortáveis para a rotina de trabalho." } },
    { '@type': 'Question', name: "Posso escolher cores diferenciadas para o jaleco feminino de podóloga, além do branco?", acceptedAnswer: { '@type': 'Answer', text: "Sim, disponibilizamos cores suaves e modernas como rosa quartz, azul serenity ou verde água, que trazem um toque delicado e atual, sem comprometer a imagem profissional. Verifique as políticas do seu consultório." } },
    { '@type': 'Question', name: "Como é o corte dos jalecos femininos de podóloga, pensando na feminilidade e mobilidade?", acceptedAnswer: { '@type': 'Answer', text: "Nossos modelos femininos são projetados com cortes acinturados e pences, valorizando a silhueta sem restringir os movimentos. Oferecemos um visual elegante e funcional para a podologia." } },
    { '@type': 'Question', name: "É possível personalizar meu jaleco com meu nome e a palavra 'Podóloga'?", acceptedAnswer: { '@type': 'Answer', text: "Sim, você pode solicitar o bordado do seu nome e da sua especialidade no momento da compra. Garantimos um bordado de alta qualidade que realça sua identificação profissional." } },
    { '@type': 'Question', name: "Quais as melhores práticas para lavar o jaleco feminino de podóloga para máxima higiene?", acceptedAnswer: { '@type': 'Answer', text: "Lave em água fria ou morna, com sabão neutro e utilize produtos que garantam a desinfecção, se necessário. Seque à sombra e separe por cores para manter a qualidade e evitar manchas." } },
    { '@type': 'Question', name: "Um jaleco feminino de podóloga de boa qualidade tem durabilidade garantida?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos são feitos com tecidos duráveis e costuras reforçadas, desenvolvidos para suportar o uso diário e as rigorosas lavagens exigidas na podologia, mantendo a peça bonita por anos." } },
    { '@type': 'Question', name: "Como escolher o tamanho perfeito para o jaleco feminino de podóloga?", acceptedAnswer: { '@type': 'Answer', text: "Recomendamos consultar nossa tabela de medidas e tirar suas medidas de busto, cintura e quadril. Um jaleco com caimento ideal é fundamental para o conforto e a imagem profissional." } },
    { '@type': 'Question', name: "Há opções de comprimentos variados para o jaleco feminino de podóloga?", acceptedAnswer: { '@type': 'Answer', text: "O comprimento clássico, que geralmente termina na altura do quadril ou meio da coxa, é o mais adequado. Ele oferece a cobertura necessária e não atrapalha os movimentos durante o atendimento." } },
    { '@type': 'Question', name: "Estão disponíveis jalecos de podóloga com manga 3/4 ou manga curta?", acceptedAnswer: { '@type': 'Answer', text: "Sim, além da tradicional manga longa, temos modelos com manga 3/4 ou manga curta, ideais para maior conforto e liberdade de movimento, adaptando-se às suas preferências e ao ambiente." } },
    { '@type': 'Question', name: "Quantos bolsos um jaleco de podóloga possui e qual sua finalidade?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos femininos para podólogas vêm com um bolso superior e dois bolsos inferiores, pensados para a praticidade de guardar pequenos instrumentos, canetas e outros itens essenciais." } },
    { '@type': 'Question', name: "Qual o estilo dos jalecos femininos de podóloga para um visual elegante e cuidadoso?", acceptedAnswer: { '@type': 'Answer', text: "Priorizamos um estilo moderno e feminino, com detalhes que valorizam a profissional. Nossos designs buscam transmitir confiança, delicadeza e a atenção aos detalhes inerente à podologia." } },
    { '@type': 'Question', name: "O que distingue um jaleco de podóloga de um jaleco de esteticista?", acceptedAnswer: { '@type': 'Answer', text: "O jaleco de podóloga é desenhado com foco na praticidade e higiene para tratamentos específicos dos pés, enquanto o de esteticista pode ter mais elementos de moda e adaptabilidade a diferentes procedimentos corporais e faciais." } },
    { '@type': 'Question', name: "É possível conseguir um preço melhor ao comprar vários jalecos para a equipe de podólogas?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos descontos para pedidos em volume, ideais para padronizar sua equipe de podólogas com peças de alta qualidade. Contate nosso setor de vendas para uma cotação personalizada." } },
    { '@type': 'Question', name: "Qual o preço inicial de um jaleco feminino de podóloga com bordado?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos femininos de podóloga têm preços a partir de R$ 122,00, com a opção de bordado personalizado já inclusa. Consulte nosso site para detalhes de modelos e tecidos." } },
    { '@type': 'Question', name: "Qual o prazo de entrega para jalecos de podóloga personalizados com nome?", acceptedAnswer: { '@type': 'Answer', text: "O prazo de entrega para jalecos personalizados é de 7 a 18 dias úteis, incluindo o tempo de produção e envio. Você receberá um código de rastreio para acompanhar o seu pedido online." } },
    { '@type': 'Question', name: "Como proceder em caso de necessidade de troca do jaleco de podóloga por tamanho?", acceptedAnswer: { '@type': 'Answer', text: "Aceitamos trocas em até 7 dias corridos após o recebimento, desde que o jaleco esteja sem uso. Para peças com bordado personalizado, aplicam-se condições especiais, por favor, consulte-nos." } },
    { '@type': 'Question', name: "Há alguma oferta de frete grátis para a compra de jalecos de podóloga?", acceptedAnswer: { '@type': 'Answer', text: "Sim, periodicamente realizamos promoções de frete grátis para compras acima de um valor determinado ou para regiões específicas. Fique atenta às nossas ofertas em nosso site." } },
    { '@type': 'Question', name: "Os jalecos femininos para podólogas vêm com alguma garantia?", acceptedAnswer: { '@type': 'Answer', text: "Com certeza. Todos os nossos jalecos possuem garantia de 60 dias contra defeitos de fabricação, assegurando a qualidade e a sua total satisfação com o produto." } },
    { '@type': 'Question', name: "O tecido do jaleco de podóloga é respirável para longas horas de uso?", acceptedAnswer: { '@type': 'Answer', text: "Selecionamos tecidos leves e respiráveis que garantem conforto térmico durante toda a jornada de trabalho, essencial para o ambiente da podologia, onde a atenção e o conforto são primordiais." } },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Podóloga', item: 'https://jaleca.com.br/jaleco-podologa' },
  ],
}
...
async function getJalecos(): Promise<WooProduct[]> {
  try {
    ...
    const slugs = PROFESSION_PRODUCT_SLUGS['podologa'] ?? []
...
export default async function JalecoDentistaPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    ...
    getGooglePlaceData(),
    getCachedHeroImage(getHeroImageSlug('podologa') ?? ''),
  ])
  ...
  return (
    <>
      ...
      {(() => { const s = buildItemListSchema(produtos, 'https://jaleca.com.br/jaleco-podologa', "Jalecos para podologa"); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const arr = buildProductListSchema(produtos, 'https://jaleca.com.br/jaleco-podologa'); return arr ? arr.map((s, i) => <script key={'p'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      {(() => { const arr = buildReviewSchema(placeData?.reviews, 'https://jaleca.com.br/jaleco-podologa', "Jaleco para podologa", produtos); return arr ? arr.map((s, i) => <script key={'r'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
        ...
        {produtos.length > 0 && (
          <section id="produtos" className="px-4 py-12 lg:px-16 lg:py-20" style={{ background: '#f9f7f4', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
            <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
              <div className="mb-10">
                <div>
                  <div style={{ fontSize: '0.7rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#c8c4bc', marginBottom: '0.75rem' }}>Coleção podóloga</div>
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Jalecos para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Podólogas</em>
                  </h2>
                </div>
                </div>
              ...
              <div className="flex justify-center mt-8">
                <Link href={getVerMaisUrl('podologa')} style={{ display: 'inline-flex', padding: '0.9rem 2rem', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a', color: '#1a1a1a' }}>
                  Ver mais →
                </Link>
              </div>
            </div>
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Jaleco de podóloga aguenta muita lavagem e mancha. Precisa ser confortável por horas.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
