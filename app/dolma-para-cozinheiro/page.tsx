...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/dolma-para-cozinheiro' },
  openGraph: {
    title: 'Dolma para Cozinheiro | Conforto e Praticidade — Jaleca',
    description: 'Dolma profissional para cozinheiro. Tecido técnico, fácil limpeza, maleabilidade para cozinha. Frete grátis.',
    url: 'https://jaleca.com.br/dolma-para-cozinheiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
  twitter: {
    ...
    title: 'Dolma para Cozinheiro | Jaleca',
    description: 'Dolma profissional para cozinheiro. Tecido técnico para cozinha. Frete grátis.',
...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Dolma para cozinheiro é diferente do jaleco comum?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. A dolma tem caimento mais solto e tecido técnico resistente a gordura e umidade. É própria para ambientes de cozinha quente onde o jaleco comum seria desconfortável e difícil de limpar.' } },
    { '@type': 'Question', name: 'Qual o melhor tecido para dolma de cozinheiro?', acceptedAnswer: { '@type': 'Answer', text: 'O tecido com elastano e tratamento antipeling é o mais indicado. Oferece maleabilidade para movimento, resistência a manchas de gordura e secagem rápida após lavagem.' } },
    { '@type': 'Question', name: 'Dolma pode ser usada em restaurante comercial?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. A dolma é amplamente usada em restaurantes, buffets, hotéis e cozinhas industriais por oferecer conforto térmico, liberdade de movimento e fácil manutenção.' } },
    { '@type': 'Question', name: 'Como manter a dolma limpa em cozinha profissional?', acceptedAnswer: { '@type': 'Answer', text: 'Lave imediatamente após o uso para evitar manchas de gordura fixadas. Use sabão neutro e água morna. O tecido técnico Jaleca seca rápido e não precisa passar. Evite alvejante.' } },
    { '@type': 'Question', name: 'Dolma ou jaleco: qual é melhor para cozinheiro?', acceptedAnswer: { '@type': 'Answer', text: 'Para a área de preparo, a dolma é mais prática por ser mais ventilada e fácil de limpar. Para área de serviço mais formal, o jaleco pode ser mais adequado dependendo do estilo do restaurante.' } },
    { '@type': 'Question', name: 'A dolma protege contra queimaduras?', acceptedAnswer: { '@type': 'Answer', text: 'A dolma Jaleca protege contra respingos de gordura e sujeira do dia a dia da cozinha, mas não é um EPI contra calor extremo ou queimaduras. Para trabalho direto com panelas quentes, use luvas e avental adequado.' } },
  ],
}
...
const schemaArticle = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'Dolma para Cozinheiro: Conforto e Praticidade para Cozinha Profissional',
  description: 'Guia completo da dolma para cozinheiro: tecido técnico, conforto em cozinha quente, diferença entre dolma e jaleco, e custo-benefício.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Cozinheiro', item: 'https://jaleca.com.br/dolma-para-cozinheiro' },
  ],
}
...
async function getDolmas(): Promise<WooProduct[]> {
  try {
    ...
    const cozinheiroSlugs = PROFESSION_PRODUCT_SLUGS['cozinheiro'] ?? []
    const products = data?.products?.nodes ?? []
    return products.filter(p => cozinheiroSlugs.includes(p.slug) || p.slug.includes('dolma') || p.slug.includes('scrub')).slice(0, 6)
  } catch {
    return []
  }
}
...
async function getBlogPosts(): Promise<WPPost[]> {
  try {
    const posts = await getPosts({ per_page: 3, search: 'cozinha profissional' })
...
export default async function DolmaCozinheiroPage() {
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        <div style={{ background: '#f9f7f4', borderBottom: '1px solid #e5e0d8', padding: '0.85rem clamp(1.5rem,5vw,4rem)' }}>
          <ol className="flex items-center gap-2 max-w-[1200px] mx-auto" style={{ listStyle: 'none' }}>
            {[
              ...
              { label: 'Para Cozinheiro', href: null },
            ].map((crumb, i, arr) => (
        ...
        >
          ...
          >
            ...
            >
              Dolma para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Cozinheiro</em>
            </h1>
        ...
        <div className="grid" style={{ gridTemplateColumns: 'repeat(4,1fr)', background: '#1a1a1a', padding: '2rem clamp(1.5rem,5vw,4rem)' }}>
          {[
            ...
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 20, height: 20 }}><ellipse cx="12" cy="12" rx="9" ry="6" /><path d="M12 3v18M3 12h18" opacity=".5" /></svg>, title: 'Tecido técnico', sub: 'Resistente a gordura' },
              ...
              <div className="flex justify-between items-end flex-wrap gap-4 mb-10">
                <div>
                  ...
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Dolmas para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Cozinheiros</em>
                  </h2>
                </div>
            ...
            <div className="grid" style={{ gridTemplateColumns: '280px 1fr', gap: 'clamp(3rem,6vw,6rem)', alignItems: 'start' }}>
              <aside style={{ position: 'sticky', top: 80 }}>
                ...
                <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: '1.8rem', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a', marginBottom: '1.5rem' }}>
                  Como escolher a dolma ideal para cozinha profissional
                </h2>
                <nav>
                  <ul style={{ listStyle: 'none' }}>
                    {[
                      ...
                      { label: 'Conforto em cozinha quente', anchor: '#calor' },
                      { label: 'Limpeza e manutenção', anchor: '#limpeza' },
                      { label: 'Segurança na cozinha', anchor: '#seguranca' },
                    ].map(item => (
              ...
              <article>
                {[
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Cozinheiro trabalha em ambiente quente e graxo. O tecido da dolma precisa ser resistente a manchas, permitir ventilação e ser fácil de lavar.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Na Jaleca, as dolmas têm elastano e tratamento antipeling, o que significa que resistem a manchas de gordura e mantêm a aparência mesmo após múltiplas lavagens.
                        </p>
                        <div style={{ background: '#1a1a1a', color: '#fff', padding: '1.5rem 2rem', margin: '2rem 0', borderLeft: '3px solid #c8c4bc' }}>
                          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.95rem', fontStyle: 'italic', fontWeight: 300, margin: 0 }}>
                            "A dolma certa não atrapalha no calor da cozinha — ela acompanha o cozinheiro sem prender."
                          </p>
                        </div>
                      </>
                    ),
                  ...
                  {
                    id: 'diferenca',
                    title: 'Dolma vs Jaleco: qual escolher para cozinha?',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          A dolma tem caimento mais solto e é mais ventilada que o jaleco tradicional. É ideal para serviço de cozinha onde o cozinheiro precisa de liberdade de movimento.
                        </p>
                        <ul style={{ listStyle: 'none', margin: '1.2rem 0 1.5rem' }}>
                          {[
                            'Dolma — caimento solto, mais ventilada, ideal para preparo e serviço',
                            'Jaleco — caimento mais ajustado, mais formal, ideal para área de atendimento',
                          ].map(item => (
                  ...
                  {
                    id: 'calor',
                    title: 'Conforto em cozinha quente',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          A dolma Jaleca é mais ventilada que o jaleco tradicional. O tecido técnico permite que o ar circule melhor, reduzindo o calor acumulado durante o serviço.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Para exposição direta ao calor extremo do fogão, indicamos usar um avental por cima da dolma para proteção adicional.
                        </p>
                      </>
                    ),
                  },
                  {
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          A dolma mancha menos que o jaleco porque o tecido técnico Jaleca tem tratamento que repele líquidos e facilita a remoção de manchas de gordura.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  },
                  {
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          A dolma não é um EPI contra calor extremo ou fogo. Para trabalho direto com panelas quentes, use equipamentos de proteção adequados como luvas e avental.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          A dolma Jaleca protege contra respingos de gordura e sujeira do dia a dia da cozinha, mas não substitui EPIs específicos para alta temperatura.
                        </p>
                      </>
                    ),
                  },
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre dolma<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>para cozinheiro</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
        ...
        <section style={{ background: '#1a1a1a', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
              {[
                { label: 'Churrasqueiro', href: '/dolma-para-churrasqueiro', desc: 'Guia completo' },
                { label: 'Sushiman', href: '/dolma-para-sushiman', desc: 'Guia completo' },
        ...
        <section style={{ background: '#f9f7f4', padding: 'clamp(5rem,10vw,9rem) clamp(1.5rem,5vw,4rem)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ fontSize: '0.97rem', color: '#6b6b6b', maxWidth: 480, margin: '0 auto 2.5rem', fontWeight: 300, lineHeight: 1.8 }}>
              Do PP ao G3. Tecido técnico resistente a gordura. Secagem rápida. Frete grátis no Sudeste para compras acima de R$499.
            </p>
