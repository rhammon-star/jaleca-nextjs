...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/dolma-para-sushiman' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/dolma-para-sushiman',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Sushiman', item: 'https://jaleca.com.br/dolma-para-sushiman' },
  ],
}
        ...
        <section style={{ background: '#1a1a1a', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
              {[
                { label: 'Cozinheiro', href: '/dolma-para-cozinheiro', desc: 'Guia completo' },
