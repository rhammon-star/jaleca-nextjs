...
const schemaFaq = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Como funciona a troca de tamanho?', acceptedAnswer: { '@type': 'Answer', text: 'Arrependimento: até 7 dias após o recebimento, produto sem uso e com etiqueta (CDC). Para defeito de fabricação, os prazos seguem o Código de Defesa do Consumidor (30 ou 90 dias). Manda mensagem pelo WhatsApp com o número do pedido.' } },
  ],
}
