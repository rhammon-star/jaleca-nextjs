...
export const metadata: Metadata = {
  title: 'Jaleco para Farmacêutico: Tecido Premium, Caimento Perfeito | Jaleca 2026',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Farmacêutico', item: 'https://jaleca.com.br/jaleco-para-farmaceutico' },
  ],
}

async function getJalecos(): Promise<WooProduct[]> {
  try {
    // Busca produtos sem filtro de categoria, depois filtra por slug de farmacêutico
