...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-esteticista' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-esteticista',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Esteticista', item: 'https://jaleca.com.br/jaleco-para-esteticista' },
  ],
}

async function getJalecos(): Promise<WooProduct[]> {
  try {
    // Busca produtos sem filtro de categoria, depois filtra por slug de esteticista
