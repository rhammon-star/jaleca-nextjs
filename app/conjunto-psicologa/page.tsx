...
export const metadata: Metadata = {
  title: { absolute: 'Conjunto Profissional para Psicóloga: Elegância e Conforto | Jaleca' },
...
export default async function ConjuntoPsicologaPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    getConjuntos(),
    getCachedBlogPosts('psicologa uniforme'),
    getGooglePlaceData(),
    getCachedHeroImage('conjunto-profissional-psicologa-jaleca'),
  ])
