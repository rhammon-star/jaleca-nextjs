    ...
    <>
      ...
      <article className="container py-12 max-w-3xl">
        ...
        <div className="mt-12 p-8 bg-[#faf9f7] border border-[#e8e0d5]">
          ...
          <Link href="/jaleco-plus-size" className="inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-6 py-3 text-sm font-semibold tracking-widest uppercase hover:bg-[#333]">
