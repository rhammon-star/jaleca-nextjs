...
export default async function BlogPage({
  ...
  const FAQ_ITEMS = [
    ...
    { '@type': 'Question', name: 'A Jaleca oferece troca de jaleco?', acceptedAnswer: { '@type': 'Answer', text: 'Arrependimento: até 7 dias após o recebimento, produto sem uso e com etiqueta (CDC). Para defeito de fabricação, os prazos seguem o Código de Defesa do Consumidor (30 ou 90 dias). Entre em contato pelo WhatsApp.' } },
  ]
