    ...
    <>
      ...
      <article className="container py-12 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Meça busto (na altura dos mamilos) e cintura (parte mais estreita). Compare com a <Link href="/jalecos-femininos" className="text-[#c4a97d]">tabela de medidas da Jaleca</Link>. Para o slim, a medida de busto é mais determinante — escolha o tamanho pelo busto e o jaleco vai casar com a cintura.
          </p>
        ...
        <div className="mt-12 p-8 bg-[#faf9f7] border border-[#e8e0d5]">
          ...
          <Link href="/jalecos-femininos" className="inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-6 py-3 text-sm font-semibold tracking-widest uppercase hover:bg-[#333]">
            Ver Jalecos Slim →
          </Link>
        </div>
