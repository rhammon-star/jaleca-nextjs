...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-cozinheiro' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-cozinheiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Cozinheiro', item: 'https://jaleca.com.br/jaleco-para-cozinheiro' },
  ],
}
