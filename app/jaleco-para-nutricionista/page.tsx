...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-nutricionista' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-nutricionista',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Nutricionista', item: 'https://jaleca.com.br/jaleco-para-nutricionista' },
  ],
}
