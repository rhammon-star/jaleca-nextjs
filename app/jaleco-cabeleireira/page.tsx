...
export const metadata: Metadata = {
  title: { absolute: 'Jaleco para Cabeleireira: Tecido Premium, Caimento Perfeito | Jaleca' },
  ...
  twitter: {
    ...
    title: 'Jaleco para Cabeleireiro | Tecido Premium, Caimento Perfeito — Jaleca',
    description: 'Jaleco premium para cabeleireira. Tecido de qualidade, caimento perfeito, preço justo. Do PP ao G3.',
