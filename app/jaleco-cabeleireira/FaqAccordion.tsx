...
const faqItems = [
  { q: 'Qual o melhor jaleco para cabeloereiro?', a: 'O cabeloereiro trabalha com produtos químicos e calor. O modelo com elastano é ideal porque é fácil de limpar e permite movimento durante os procedimentos.' },
  { q: 'Cabeloereiro pode usar jaleco?', a: 'Pode e é muito comum em salões. O jaleco protege contra tintura e produtos químicos, mantendo uma imagem profissional.' },
  { q: 'Qual a diferença entre jaleco Slim e Profissional?', a: 'O Slim tem corte mais ajustado e visual moderno. O Profissional tem mais espaço, ideal para quem trabalha em movimento constante.' },
  { q: 'O jaleco de cabeloereiro protege contra produtos químicos?', a: 'Sim. O jaleco funciona como barreira contra tintura, revelador e outros produtos químicos usados na cabeloeria.' },
