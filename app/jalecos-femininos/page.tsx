...
export default async function Page() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Jalecos Femininos', item: 'https://jaleca.com.br/jalecos-femininos' },
    ],
  }
  ...
  const socialProofSchema = {
    ...
    '@type': 'Organization',
    name: 'Jaleca',
    description: 'Mais de 200.000 jalecos femininos vendidos desde 2010. Grade PP ao G3 com molde próprio.',
        ...
        <div style={{ background: '#f9f7f4', borderBottom: '1px solid #e5e0d8', padding: '0.85rem clamp(1.5rem,5vw,4rem)' }}>
          <ol className="flex items-center gap-2 max-w-[1200px] mx-auto" style={{ listStyle: 'none' }}>
            {[
              ...
              { label: 'Jalecos Femininos', href: null },
            ].map((crumb, i, arr) => (
        ...
        <section style={{ background: '#1a1a1a', padding: 'clamp(3rem,6vw,5rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
            ...
            <div className="grid" style={{ gridTemplateColumns: 'repeat(3,1fr)', gap: '2rem', marginTop: '2.5rem' }}>
              {[
                { numero: '200.000+', label: 'jalecos femininos vendidos' },
