...
export const metadata: Metadata = {
  title: 'Jaleco para Biomédico: Norma ANVISA e Conforto em Laboratório | Jaleca 2026',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Biomédico', item: 'https://jaleca.com.br/jaleco-para-biomedico' },
  ],
}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            >
              Jaleco para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Biomédico</em>
            </h1>
