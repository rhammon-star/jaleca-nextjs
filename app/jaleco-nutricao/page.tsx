...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Toda a equipe de uma clínica de nutrição precisa usar jaleco com CRN bordado?", acceptedAnswer: { '@type': 'Answer', text: "Geralmente, apenas os nutricionistas licenciados bordam o CRN. Para a equipe de apoio, é comum bordar o nome da clínica ou do colaborador, promovendo padronização e profissionalismo." } },
    { '@type': 'Question', name: "Qual o tecido mais adequado para os jalecos da equipe de uma clínica de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "Recomendamos tecidos leves e resistentes como gabardine ou microfibra, que são fáceis de cuidar, secam rapidamente e oferecem conforto para a equipe durante o expediente." } },
    { '@type': 'Question', name: "Podemos personalizar os jalecos da equipe de nutrição com as cores da nossa marca?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos diversas opções de cores para que os jalecos se alinhem perfeitamente à identidade visual da sua clínica de nutrição, criando um ambiente harmonioso e profissional." } },
    { '@type': 'Question', name: "Qual o corte ideal para jalecos de equipe de nutrição, pensando em funcionalidade e apresentação?", acceptedAnswer: { '@type': 'Answer', text: "Nossos cortes são pensados para oferecer conforto e mobilidade, com um visual clean e profissional que se adapta a diferentes biotipos, mantendo a uniformidade da equipe." } },
    { '@type': 'Question', name: "É possível bordar o logo da clínica de nutrição e os nomes da equipe nos jalecos?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos o serviço de bordado personalizado para o logo da sua clínica e os nomes dos colaboradores. É uma excelente forma de fortalecer a marca e identificar a equipe." } },
    { '@type': 'Question', name: "Quais as melhores práticas para a lavagem dos jalecos da equipe de nutrição em volume?", acceptedAnswer: { '@type': 'Answer', text: "Para lavagem em volume, sugerimos ciclos delicados com água fria e sabão neutro. A secagem em cabides e à sombra ajuda a preservar a qualidade e a cor dos jalecos." } },
    { '@type': 'Question', name: "Qual a durabilidade esperada para os jalecos de uma equipe de nutrição com uso intenso?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos são fabricados com tecidos de alta qualidade e costuras reforçadas, desenvolvidos para resistir ao uso diário e às lavagens frequentes, prolongando sua vida útil." } },
    { '@type': 'Question', name: "Como faço para escolher os tamanhos para a equipe de nutrição em um pedido corporativo?", acceptedAnswer: { '@type': 'Answer', text: "Disponibilizamos uma tabela de medidas detalhada para auxiliar na escolha. Recomendamos que cada membro da equipe consulte-a para garantir o ajuste perfeito e evitar trocas." } },
    { '@type': 'Question', name: "Os jalecos para clínicas de nutrição têm comprimento padrão ou opções variadas?", acceptedAnswer: { '@type': 'Answer', text: "O comprimento padrão de nossos jalecos, geralmente na altura do quadril, oferece a versatilidade e a apresentação adequadas para a rotina em uma clínica de nutrição." } },
    { '@type': 'Question', name: "Há opções de manga curta ou 3/4 para os jalecos da equipe de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos modelos com manga longa e também com manga curta ou 3/4, permitindo que sua equipe escolha a opção que melhor se adapte ao conforto e ao ambiente de trabalho." } },
    { '@type': 'Question', name: "Quantos bolsos são úteis em um jaleco para clínica de nutrição e onde ficam?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos contam com três bolsos: um no peito e dois na parte inferior. São práticos para armazenar itens como canetas, blocos de anotações ou pequenos acessórios." } },
    { '@type': 'Question', name: "Que estilo de jaleco é mais indicado para transmitir a imagem de uma clínica de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "Propomos um estilo moderno, clean e profissional, que reflete a seriedade e o cuidado da área da nutrição. O design é pensado para aprimorar a imagem da sua clínica." } },
    { '@type': 'Question', name: "Qual a diferença entre um jaleco individual de nutricionista e um jaleco para a equipe de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "O jaleco individual foca em detalhes e personalização específica do profissional. O jaleco de equipe visa a padronização, durabilidade para uso contínuo e a representação da marca da clínica." } },
    { '@type': 'Question', name: "É possível obter descontos para grandes encomendas de jalecos para clínicas de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos preços especiais e descontos progressivos para compras em grande volume. Entre em contato com nosso setor comercial para um orçamento personalizado e vantagens exclusivas." } },
    { '@type': 'Question', name: "Qual o valor inicial de um jaleco para a equipe de uma clínica de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos para equipes de nutrição têm preços a partir de R$ 98,00, sem personalização. Os valores podem variar dependendo do modelo, tecido e quantidade solicitada." } },
    { '@type': 'Question', name: "Qual o prazo de entrega para um pedido de jalecos para toda a equipe de nutrição com logo bordado?", acceptedAnswer: { '@type': 'Answer', text: "Para pedidos corporativos com bordado, o prazo de entrega pode variar de 10 a 20 dias úteis, adicionando o tempo de produção e envio. Recomendamos planejar a compra com antecedência." } },
    { '@type': 'Question', name: "Qual a política de troca para pedidos de jalecos de nutrição para equipes, se houver erros de tamanho?", acceptedAnswer: { '@type': 'Answer', text: "Para pedidos em volume, a troca de peças sem uso é avaliada em até 15 dias após o recebimento. Aconselhamos a conferência das medidas antes da finalização do pedido para evitar inconvenientes." } },
    { '@type': 'Question', name: "Há alguma facilidade de frete para compras em quantidade de jalecos para clínicas de nutrição?", acceptedAnswer: { '@type': 'Answer', text: "Sim, para pedidos em grande volume, podemos oferecer condições especiais de frete, incluindo a possibilidade de frete grátis, dependendo da região e do valor total. Consulte-nos para mais detalhes." } },
    { '@type': 'Question', name: "Os jalecos para equipes de nutrição vêm com alguma garantia de fabricação?", acceptedAnswer: { '@type': 'Answer', text: "Todos os nossos jalecos são cobertos por uma garantia de 90 dias contra defeitos de fabricação. Nosso compromisso é com a qualidade e a satisfação da sua equipe de nutrição." } },
    { '@type': 'Question', name: "Os tecidos dos jalecos para nutrição são antimicrobianos ou de fácil descontaminação?", acceptedAnswer: { '@type': 'Answer', text: "Nossos tecidos são de fácil lavagem e permitem alta higienização, fundamental para ambientes de saúde. Embora não sejam antimicrobianos, sua superfície lisa facilita a limpeza e descontaminação." } },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Nutrição', item: 'https://jaleca.com.br/jaleco-nutricao' },
  ],
}
...
async function getJalecos(): Promise<WooProduct[]> {
  try {
    ...
    // Filtra por profissão nutricionista
    const slugs = PROFESSION_PRODUCT_SLUGS['nutricionista'] ?? []
...
export default async function JalecoNutricaoPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    getJalecos(),
    getCachedBlogPosts('jaleco'),
    getGooglePlaceData(),
    getCachedHeroImage(getHeroImageSlug('nutricao') ?? ''),
  ])
  ...
  return (
    <>
      ...
      {(() => { const s = buildHowToSchema('jaleco-nutricao', 'https://jaleca.com.br/jaleco-nutricao'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const s = buildOccupationSchema('jaleco-nutricao', 'https://jaleca.com.br/jaleco-nutricao'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const s = buildItemListSchema(produtos, 'https://jaleca.com.br/jaleco-nutricao', "Jalecos para nutricao"); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const arr = buildProductListSchema(produtos, 'https://jaleca.com.br/jaleco-nutricao'); return arr ? arr.map((s, i) => <script key={'p'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      {(() => { const arr = buildReviewSchema(placeData?.reviews, 'https://jaleca.com.br/jaleco-nutricao', "Jaleco para nutricao", produtos); return arr ? arr.map((s, i) => <script key={'r'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        {/* ── HERO ── */}
        <HeroCommercial
          eyebrow="Para Nutrição"
          h1Line1="Jaleco para"
          h1Line2="Nutrição"
          description="Modelagem feminina valorizando, com elastano para o conforto do dia a dia em consultório."
          startingPrice="R$220"
        ...
        {produtos.length > 0 && (
          <section id="produtos" className="px-4 py-12 lg:px-16 lg:py-20" style={{ background: '#f9f7f4', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
            <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
              <div className="mb-10">
                <div>
                  <div style={{ fontSize: '0.7rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#c8c4bc', marginBottom: '0.75rem' }}>Coleção nutrição</div>
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Jalecos para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Nutrição</em>
                  </h2>
                </div>
                </div>
              ...
              <div className="flex justify-center mt-8">
                <Link href={getVerMaisUrl('nutricao')} style={{ display: 'inline-flex', padding: '0.9rem 2rem', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a', color: '#1a1a1a' }}>
                  Ver mais →
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 lg:gap-24" style={{ gap: 'clamp(3rem,6vw,6rem)', alignItems: 'start' }}>
              <aside style={{ position: 'sticky', top: 80 }}>
                ...
                <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: '1.8rem', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a', marginBottom: '1.5rem' }}>
                  Como escolher o jaleco ideal para nutrição
                </h2>
                <nav className="hidden lg:block">
                  <ul style={{ listStyle: 'none' }}>
                    {[
                      ...
                      { label: 'Normas do CFN', anchor: '#cfn' },
                    ].map(item => (
              ...
              <article>
                {[
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Jaleco de nutricionista aguenta muita lavagem e mancha. Precisa ser confortável por horas.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  {
                    id: 'cores',
                    title: 'Jaleco branco ou colorido: o que o CFN diz',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O branco é o clássico, claro. Mas o CFN não restringe cores.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  {
                    id: 'cro',
                    title: 'Normas do CFN sobre vestimenta profissional',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O CFN, junto com a ANVISA, exige: use o jaleco só no trabalho. Nunca em transporte ou fora da clínica. A peça precisa estar sempre limpa e em bom estado.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Nutrição</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3" style={{ gap: '2px', background: '#e5e0d8', marginTop: '3rem' }}>
              {posts.length > 0 ? posts.map(post => {
                ...
                [
                  ...
                  { title: 'Jaleco branco: tradição e protocolos em nutrição', href: '/blog', tag: 'Nutrição', excerpt: 'Por que o branco é tão usado em nutrição e o que recomendam sobre cores e vestimenta.' },
