...
export const metadata: Metadata = {
  title: 'Jaleco para Barbeiro: Estilo e Praticidade na Barbearia | Jaleca 2026',
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-barbeiro' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-barbeiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Barbeiro', item: 'https://jaleca.com.br/jaleco-para-barbeiro' },
  ],
}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            >
              Jaleco para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Barbeiro</em>
            </h1>
            <p style={{ fontSize: '1rem', fontWeight: 300, color: '#6b6b6b', maxWidth: 420, marginBottom: '2.5rem', lineHeight: 1.8 }}>
              Estilo e praticidade para a barbearia moderna. Tecido premium com elastano.
            </p>
            <div className="flex gap-4 flex-wrap">
              <Link href="/produtos?categoria=jalecos-masculinos" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.9rem 2rem', background: '#1a1a1a', color: '#fff', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a' }}>
                Ver masculino ↗
              </Link>
