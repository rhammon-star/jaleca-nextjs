...
export const metadata: Metadata = {
  title: 'Dólmã para Sushiman: Tecido Premium, Caimento Perfeito | Jaleca 2026',
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-sushiman' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-sushiman',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Sushiman', item: 'https://jaleca.com.br/jaleco-para-sushiman' },
  ],
}
