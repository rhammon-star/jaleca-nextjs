...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Advogado', item: 'https://jaleca.com.br/jaleco-para-advogado' },
  ],
}
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
              {[
                ...
                { label: 'Secretária', href: '/jaleco-para-secretaria', desc: 'Guia completo' },
