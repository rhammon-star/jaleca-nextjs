...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "É obrigatório bordar o número do CRN no jaleco feminino de nutricionista?", acceptedAnswer: { '@type': 'Answer', text: "Não é uma exigência legal, mas o bordado do seu número de CRN no jaleco é uma forma de identificação e valorização profissional. Oferecemos este serviço com a melhor qualidade." } },
    { '@type': 'Question', name: "Qual o tecido ideal para um jaleco de nutricionista que preza por higiene e bom caimento?", acceptedAnswer: { '@type': 'Answer', text: "Recomendamos tecidos como gabardine ou microfibra. São leves, têm bom caimento, são fáceis de lavar, secam rápido e mantêm a peça impecável durante todo o dia no consultório." } },
    { '@type': 'Question', name: "Posso escolher outras cores além do branco para meu jaleco feminino de nutricionista?", acceptedAnswer: { '@type': 'Answer', text: "Sim, temos opções em tons suaves como bege, azul claro ou cinza, que trazem um toque de personalidade sem perder a elegância. Verifique as diretrizes do seu ambiente de trabalho." } },
    { '@type': 'Question', name: "Como é o corte dos jalecos femininos para nutricionistas, buscando um visual moderno e elegante?", acceptedAnswer: { '@type': 'Answer', text: "Nossos modelos femininos possuem cortes acinturados e pences que valorizam a silhueta, proporcionando um visual profissional, sofisticado e confortável para o dia a dia." } },
    { '@type': 'Question', name: "Consigo adicionar meu nome e número de CRN no jaleco que comprar?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos o serviço de bordado personalizado para seu nome e número de CRN. Basta informar os dados no momento da compra, e garantimos um acabamento perfeito." } },
    { '@type': 'Question', name: "Quais as instruções de lavagem para manter o jaleco de nutricionista sempre higienizado e bonito?", acceptedAnswer: { '@type': 'Answer', text: "Lave em água fria com sabão neutro e evite misturar com outras cores. Seque à sombra para preservar a cor e a estrutura do tecido, garantindo a longevidade da peça." } },
    { '@type': 'Question', name: "Qual a durabilidade média de um jaleco de nutricionista de alta qualidade?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos são feitos com tecidos resistentes e costura reforçada, projetados para durar por vários anos com uso frequente e os cuidados de lavagem adequados." } },
    { '@type': 'Question', name: "Como escolher o tamanho correto para o jaleco feminino de nutricionista?", acceptedAnswer: { '@type': 'Answer', text: "Consulte nossa tabela de medidas e compare com suas próprias medidas de busto, cintura e quadril. Um tamanho adequado garante conforto e um visual mais profissional." } },
    { '@type': 'Question', name: "Há variações de comprimento para os jalecos femininos de nutricionista?", acceptedAnswer: { '@type': 'Answer', text: "Nosso comprimento padrão para jalecos femininos geralmente vai até a altura do quadril ou meio da coxa, oferecendo elegância e praticidade para sua rotina no consultório." } },
    { '@type': 'Question', name: "Existem opções de jalecos de nutricionista com manga ¾ ou curta?", acceptedAnswer: { '@type': 'Answer', text: "Sim, além da manga longa tradicional, dispomos de modelos com manga ¾ ou curta, ideais para maior conforto em ambientes mais quentes ou preferência pessoal no atendimento." } },
    { '@type': 'Question', name: "Quantos bolsos um jaleco de nutricionista normalmente possui e qual sua utilidade?", acceptedAnswer: { '@type': 'Answer', text: "Nossos modelos vêm com um bolso superior no peito e dois bolsos inferiores, estrategicamente posicionados para carregar canetas, bloquinhos ou pequenos itens essenciais." } },
    { '@type': 'Question', name: "Qual o estilo dos jalecos para nutricionistas para transmitir credibilidade e cuidado?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos combinam um estilo clássico com toques modernos, como golas diferenciadas, transmitindo profissionalismo, confiança e uma imagem de cuidado e bem-estar." } },
    { '@type': 'Question', name: "Qual a diferença de um jaleco de nutricionista para um jaleco de esteticista?", acceptedAnswer: { '@type': 'Answer', text: "O jaleco de nutricionista prioriza um visual mais formal e clínico, enquanto o de esteticista pode ter mais detalhes de moda, como cores e recortes, e foco na praticidade para o atendimento estético." } },
    { '@type': 'Question', name: "Posso encomendar jalecos para minha equipe de nutricionistas com descontos?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos condições especiais e descontos progressivos para compras em volume. Entre em contato com nossa equipe de vendas para obter um orçamento personalizado." } },
    { '@type': 'Question', name: "Qual o preço inicial de um jaleco feminino de nutricionista com bordado?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos femininos de nutricionista iniciam a partir de R$ 125,00, já com a opção de bordado personalizado incluída. Visite nosso site para conhecer todos os modelos." } },
    { '@type': 'Question', name: "Qual o prazo de entrega para jalecos de nutricionista personalizados com meu CRN?", acceptedAnswer: { '@type': 'Answer', text: "O prazo de entrega para jalecos personalizados varia de 7 a 18 dias úteis, considerando a produção e o transporte. Você será notificado a cada etapa do processo." } },
    { '@type': 'Question', name: "Como funciona a política de troca em caso de tamanho incorreto do jaleco de nutricionista?", acceptedAnswer: { '@type': 'Answer', text: "Aceitamos trocas em até 7 dias corridos após o recebimento, desde que o produto esteja sem uso e em sua embalagem original. Para itens bordados, aplicam-se condições específicas." } },
    { '@type': 'Question', name: "Oferecem frete grátis em compras de jalecos para nutricionistas em alguma ocasião?", acceptedAnswer: { '@type': 'Answer', text: "Sim, ocasionalmente disponibilizamos frete grátis para compras acima de um determinado valor ou durante promoções específicas. Acompanhe nossas novidades no site." } },
    { '@type': 'Question', name: "Os jalecos para nutricionistas possuem alguma garantia de qualidade e durabilidade?", acceptedAnswer: { '@type': 'Answer', text: "Absolutamente. Todos os nossos jalecos contam com garantia de 60 dias contra defeitos de fabricação, assegurando a sua total satisfação e a excelência do produto." } },
    { '@type': 'Question', name: "O tecido do jaleco para nutricionista é confortável para usar durante o dia todo?", acceptedAnswer: { '@type': 'Answer', text: "Sim, selecionamos tecidos leves e respiráveis que garantem conforto excepcional, permitindo que você se mova livremente e mantenha o foco no atendimento aos seus pacientes." } },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Nutricionista', item: 'https://jaleca.com.br/jaleco-nutricionista' },
  ],
}
...
export default async function JalecoDentistaPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    ...
    getGooglePlaceData(),
    getCachedHeroImage(getHeroImageSlug('nutricionista') ?? ''),
  ])
  ...
  return (
    <>
      ...
      {(() => { const s = buildHowToSchema('jaleco-nutricionista', 'https://jaleca.com.br/jaleco-nutricionista'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        <div style={{ background: '#f9f7f4', borderBottom: '1px solid #e5e0d8', padding: '0.85rem clamp(1.5rem,5vw,4rem)' }}>
          <ol className="flex items-center gap-2 max-w-[1200px] mx-auto" style={{ listStyle: 'none' }}>
            {[
              ...
              { label: 'Para Nutricionista', href: null },
            ].map((crumb, i, arr) => (
          ...
          <section id="produtos" className="px-4 py-12 lg:px-16 lg:py-20" style={{ background: '#f9f7f4', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
            <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
              <div className="mb-10">
                <div>
                  ...
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Jalecos para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Nutricionistas</em>
                  </h2>
                </div>
                </div>
              ...
              <div className="flex justify-center mt-8">
                <Link href={getVerMaisUrl('nutricionista')} style={{ display: 'inline-flex', padding: '0.9rem 2rem', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a', color: '#1a1a1a' }}>
                  Ver mais →
                </Link>
              </div>
            </div>
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre jaleco<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>para nutricionista</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
        ...
        <section style={{ background: '#f9f7f4', padding: 'clamp(5rem,10vw,9rem) clamp(1.5rem,5vw,4rem)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <EATBlock profession="nutricionista" />
