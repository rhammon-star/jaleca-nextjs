...
export const metadata: Metadata = {
  title: 'Uniforme para Cozinheiro: Dólmã Profissional de Cozinha | Jaleca 2026',
  description: 'Uniforme profissional para cozinheiro. Dólmã de cozinheiro com elastano, resistente à gordura e confortável. Frete grátis SP/RJ/MG/ES. Jaleca.',
  alternates: { canonical: 'https://jaleca.com.br/jaleco-cozinheiro' },
  openGraph: {
    title: 'Uniforme para Cozinheiro | Dólmã Profissional — Jaleca',
    description: 'Qual uniforme usar na cozinha? Dólmã profissional resistente à gordura, conforto térmico e preço justo. Frete grátis.',
    url: 'https://jaleca.com.br/jaleco-cozinheiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
  twitter: {
    ...
    title: 'Uniforme para Cozinheiro | Dólmã Profissional — Jaleca',
    description: 'Dólmã profissional para cozinheiro. Tecido resistente, conforto térmico, preço justo. Frete grátis.',
...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Qual o melhor uniforme para cozinheiro?', acceptedAnswer: { '@type': 'Answer', text: 'O cozinheiro profissional precisa de um uniforme que suporte altas temperaturas e respingos de gordura. A Jaleca recomenda os dólares de cozinheiro — desenvolvidos para a rotina pesada da cozinha.' } },
...
const schemaArticle = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'Uniforme para Cozinheiro: Dólmã Profissional de Cozinha',
  description: 'Guia completo do uniforme para cozinheiro: dólar profissional, resistência à gordura, conforto térmico e custo-benefício.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Cozinheiro', item: 'https://jaleca.com.br/jaleco-cozinheiro' },
  ],
}
...
async function getProducts(): Promise<WooProduct[]> {
  try {
    ...
    const slugs = PROFESSION_PRODUCT_SLUGS['cozinheiro'] ?? []
...
export default async function JalecoCozinheiroPage() {
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '1rem', fontWeight: 300, color: '#6b6b6b', maxWidth: 420, marginBottom: '2.5rem', lineHeight: 1.8 }}>
              Dólmã resistente à gordura, conforto térmico e durabilidade para a rotina da cozinha profissional.
            </p>
          ...
          <section style={{ background: '#f9f7f4', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
            <div style={{ maxWidth: 1200, margin: '0 auto' }}>
              <div className="flex justify-between items-end flex-wrap gap-4 mb-10">
                <div>
                  <div style={{ fontSize: '0.7rem', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#c8c4bc', marginBottom: '0.75rem' }}>Coleção cozinha profissional</div>
            ...
            <div className="grid" style={{ gridTemplateColumns: '280px 1fr', gap: 'clamp(3rem,6vw,6rem)', alignItems: 'start' }}>
              <aside style={{ position: 'sticky', top: 80 }}>
                ...
                <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: '1.8rem', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a', marginBottom: '1.5rem' }}>
                  Como escolher o uniforme ideal para cozinha
                </h2>
                <nav>
                  <ul style={{ listStyle: 'none' }}>
                    {[
                      { label: 'Dólmã vs Jaleco', anchor: '#dolma' },
                      { label: 'Tecido profissional', anchor: '#tecido' },
                      { label: 'Conforto térmico', anchor: '#termico' },
                      { label: 'EPIs na cozinha', anchor: '#epis' },
                      { label: 'Conservação e lavagem', anchor: '#conservacao' },
                    ].map(item => (
              ...
              <article>
                {[
                  {
                    id: 'dolma',
                    title: 'Dólmã vs Jaleco: qual é melhor para cozinha',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O dólar é o uniforme padrão em cozinhas profissionais ao redor do mundo. Diferente do jaleco, o dólar tem um corte mais reto e é feito com tecidos que não absorvem gordura.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O dollar é mais ventilado, mais fácil de lavar e mais durável em ambiente de alta temperatura. Para o cozinheiro profissional, é a única escolha sensata.
                        </p>
                        <div style={{ background: '#1a1a1a', color: '#fff', padding: '1.5rem 2rem', margin: '2rem 0', borderLeft: '3px solid #c8c4bc' }}>
                          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.95rem', fontStyle: 'italic', fontWeight: 300, margin: 0 }}>
                            "Na cozinha profissional, o dólar não é só uma questão de estética — é uma ferramenta de trabalho tão importante quanto a faca do chef."
                          </p>
                        </div>
                      </>
                    ),
                  ...
                  {
                    id: 'tecido',
                    title: 'Tecido profissional para cozinha',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                        ...
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O elastano nos dollars Jaleca adiciona flexibilidade ao movimento sem sacrificar a ventilação. É a combinação ideal de conforto e funcionalidade para a rotina pesada da cozinha.
                        </p>
                      </>
                    ),
                  },
                  {
                    id: 'termico',
                    title: 'Conforto térmico na cozinha',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          A cozinha profissional é um dos ambientes de trabalho mais quentes. O dólar Jaleca tem estrutura de tecido que permite maior circulação de ar, mantendo o cozinheiro mais fresco.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Diferente do jaleco tradicional, que pode ser abafado, o dólar foi desenhado para a ventilação — uma necessidade real em qualquer cozinha profissional.
                        </p>
                      </>
                    ),
                  },
                  {
                    id: 'epis',
                    title: 'EPIs obrigatórios na cozinha',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O dólar Jaleca é o uniforme base, mas não substitui os EPIs. Luvas термостойкие são obrigatórias para manipular panelas quentes. Óculos de proteção protegem contra respingos.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O avental impermeável é essencial para proteger contra respingos de óleo quente. Com o uniforme certo e os EPIs adequados, o cozinheiro trabalha com segurança.
                        </p>
                      </>
                    ),
                  },
                  {
                    id: 'conservacao',
                    title: 'Conservação e lavagem do dólar',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Lave o dólar a 60°C com sabão desengordurante para remover gorduras e resíduos alimentares. Nunca use alvejante com cloro — isso danifica o tecido e remove a proteção.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Seque à sombra para preservar a cor e a integridade do tecido. Com os cuidados certos, um dólar Jaleca dura anos mesmo em uso intensivo de cozinha profissional.
                        </p>
                      </>
                    ),
                  },
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre uniforme<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>para cozinheiro</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
        ...
        <section style={{ background: '#1a1a1a', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
              {[
                { label: 'Churrasqueiro', href: '/jaleco-churrasqueiro', desc: 'Guia completo' },
