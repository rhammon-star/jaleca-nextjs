...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-psicologa' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-psicologa',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Psicóloga', item: 'https://jaleca.com.br/jaleco-para-psicologa' },
  ],
}
