...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/melhor-marca-jaleco`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.95 },
    { url: `${SITE_URL}/jaleco-premium`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-feminino`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-estiloso`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.85 },
    // Topical Authority Hubs — Pillar pages clusters
    { url: `${SITE_URL}/uniformes-beleza`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/uniformes-gastronomia`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/uniformes-servicos`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/uniformes-escritorio`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    // Pillar page saúde
    {
    ...
    { url: `${SITE_URL}/jaleco-medico`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-enfermeiro`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-podologo`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-biomedico`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-fisioterapeuta`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-nutricionista`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-veterinario`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    // Cluster Saúde — Feminino
    { url: `${SITE_URL}/jaleco-medica`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-enfermeira`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-farmaceutica`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-veterinaria`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-biomedica`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-podologa`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-cabeleireira`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Novas landings (25/04/2026) — DataForSEO descobriu volume
    { url: `${SITE_URL}/jaleco-medicina`, lastModified: new Date('2026-04-25'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-fisioterapia`, lastModified: new Date('2026-04-25'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-odontologia`, lastModified: new Date('2026-04-25'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-nutricao`, lastModified: new Date('2026-04-25'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-farmacia`, lastModified: new Date('2026-04-25'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/scrub-enfermagem`, lastModified: new Date('2026-04-25'), changeFrequency: 'monthly', priority: 0.9 },
    // Pivot 04/26 — URLs de campanhas Google Ads (adicionadas 26/04/2026)
    { url: `${SITE_URL}/jaleco-enfermagem`, lastModified: new Date('2026-04-26'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/scrub-feminino`, lastModified: new Date('2026-04-26'), changeFrequency: 'monthly', priority: 0.9 },
    // Topical Authority Hub — Scrub Feminino (30/04/2026)
    { url: `${SITE_URL}/blog/scrub-feminino-guia-completo`, lastModified: new Date('2026-04-30'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/blog/scrub-feminino-acinturado`, lastModified: new Date('2026-04-30'), changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${SITE_URL}/blog/jaleco-slim-feminino`, lastModified: new Date('2026-04-30'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/blog/jaleco-branco-profissional`, lastModified: new Date('2026-04-30'), changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${SITE_URL}/jaleco-preto-feminino`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${SITE_URL}/pijama-cirurgico-feminino`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/jaleco-plus-size`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.85 },
    // Cluster Beleza
    { url: `${SITE_URL}/jaleco-barbeiro`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-tatuador`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-esteticista`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-massagista`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-cabeleireiro`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Gastronomia
    { url: `${SITE_URL}/jaleco-churrasqueiro`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-sushiman`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Serviços
    { url: `${SITE_URL}/jaleco-professor`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-vendedor`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Escritório
    { url: `${SITE_URL}/jaleco-advogado`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-advogada`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-pastor`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-psicologa`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/jaleco-farmaceutico`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Gastronomia — Dólmã
    { url: `${SITE_URL}/dolma-churrasqueiro`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/dolma-sushiman`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/dolma-cozinheiro`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Escritório — Conjunto
    { url: `${SITE_URL}/conjunto-advogado`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/conjunto-psicologa`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/conjunto-farmaceutico`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Serviços — Jaleco genérico professor
    { url: `${SITE_URL}/uniforme-professor`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Escritório — Secretária
    { url: `${SITE_URL}/jaleco-secretaria`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
    // Cluster Serviços — Universitário e Dona de Casa
    { url: `${SITE_URL}/jaleco-universitario`, lastModified: new Date('2026-04-21'), changeFrequency: 'monthly', priority: 0.8 },
