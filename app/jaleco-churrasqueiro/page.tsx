...
export default async function JalecoChurrasqueiroPage() {
  ...
  return (
    <>
      ...
      {(() => { const arr = buildReviewSchema(placeData?.reviews, 'https://jaleca.com.br/jaleco-churrasqueiro', "Jaleco para churrasqueiro"); return arr ? arr.map((s, i) => <script key={'r'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
