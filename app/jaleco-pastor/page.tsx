...
export const metadata: Metadata = {
  title: { absolute: 'Jaleco para Pastor: Tecido Premium, Caimento Perfeito | Jaleca' },
  ...
  openGraph: {
    ...
    description: 'Qual jaleco usar na religioso? Jaleco premium com elastano, caimento impecável e preço justo. Do PP ao G3. Frete grátis.',
  ...
  twitter: {
    ...
    title: 'Jaleco para Pastor | Tecido Premium, Caimento Perfeito — Jaleca',
    description: 'Jaleco premium para pastor. Tecido de qualidade, caimento perfeito, preço justo. Do PP ao G3.',
