...
export const metadata: Metadata = {
  title: { absolute: 'Jaleco para Tatuador: Tecido Premium, Caimento Perfeito | Jaleca' },
  ...
  openGraph: {
    ...
    description: 'Qual jaleco usar na tatuagem? Jaleco premium com elastano, caimento impecável e preço justo. Do PP ao G3. Frete grátis.',
  ...
  twitter: {
    ...
    title: 'Jaleco para Tatuador | Tecido Premium, Caimento Perfeito — Jaleca',
    description: 'Jaleco premium para tatuador. Tecido de qualidade, caimento perfeito, preço justo. Do PP ao G3.',
