...
const faqItems = [
  { q: 'Qual o melhor jaleco para tatuador?', a: 'O tatuador trabalha com tinta e seringas. O jaleco com elastano é ideal porque é fácil de limpar, confortável e permite movimento durante os procedimentos longos.' },
