...
export const metadata: Metadata = {
  title: { absolute: 'Jaleco para Enfermeira: Tecido Premium, Caimento Perfeito | Jaleca' },
  description: 'Jaleco para Enfermeira em tecido premium com caimento perfeito. Modelos Slim e Profissional do PP ao G3. Frete grátis SP/RJ/MG/ES. Jaleca — fabricante com estoque próprio.',
