...
export const metadata: Metadata = {
  title: 'Jaleco para Cabeleireiro: Tecido Premium, Caimento Perfeito | Jaleca 2026',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Cabeleireiro', item: 'https://jaleca.com.br/jaleco-para-cabeleireiro' },
  ],
}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            >
              Jaleco para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Cabeleireiro</em>
            </h1>
