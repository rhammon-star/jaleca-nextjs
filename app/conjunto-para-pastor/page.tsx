...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/conjunto-para-pastor' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/conjunto-para-pastor',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Pastor', item: 'https://jaleca.com.br/conjunto-para-pastor' },
  ],
}
