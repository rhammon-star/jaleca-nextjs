...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-secretaria' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-secretaria',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Secretária', item: 'https://jaleca.com.br/jaleco-para-secretaria' },
  ],
}
