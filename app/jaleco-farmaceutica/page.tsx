...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Qual comprimento de jaleco é mais indicado para farmacêuticos?', acceptedAnswer: { '@type': 'Answer', text: 'Para farmácia, o jaleco longo — padrão em farmácias e laboratórios para maior cobertura.' } },
    ...
    { '@type': 'Question', name: 'Jaleco com elastano é bom para farmacêutico?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. O elastano adiciona memória ao tecido, retornando à forma após o movimento — essencial para quem passa horas em atendimento.' } },
    { '@type': 'Question', name: 'Jaleco de farmacêutico precisa ser branco?', acceptedAnswer: { '@type': 'Answer', text: 'Não é obrigação. O branco é o clássico, mas tons pastel e cores discretas são aceitos. O CRF não restringe a cor.' } },
