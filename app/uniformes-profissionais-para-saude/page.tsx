...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/uniformes-profissionais-para-saude' },
  openGraph: {
    title: 'Uniformes Profissionais para Saúde: Guia Completo 2026 | Jaleca',
    ...
    url: 'https://jaleca.com.br/uniformes-profissionais-para-saude',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const SAUDE_HUBS = [
  { href: '/jaleco-para-medico',          titulo: 'Médico',          desc: 'CFM 1931/2009 · manga longa · NR-32' },
  { href: '/jaleco-para-dentista',        titulo: 'Dentista',        desc: 'NR-32 · antimicrobiano · scrub' },
  { href: '/jaleco-para-enfermeiro',      titulo: 'Enfermeiro',      desc: 'COFEN 375/2011 · elastano · scrub' },
  { href: '/jaleco-para-farmaceutico',    titulo: 'Farmacêutico',    desc: 'RDC 44/2009 · antimicrobiano · manga longa' },
  { href: '/jaleco-para-fisioterapeuta',  titulo: 'Fisioterapeuta',  desc: 'COFFITO 424/2013 · stretch · ergonomia' },
  { href: '/jaleco-para-nutricionista',   titulo: 'Nutricionista',   desc: 'CFN 380/2005 · toque neutro · clínica' },
  { href: '/jaleco-para-biomedico',       titulo: 'Biomédico',       desc: 'CRBio · DWR · laboratório' },
  { href: '/jaleco-para-veterinario',     titulo: 'Veterinário',     desc: 'CFMV 1138/2016 · funcional · clínica' },
  { href: '/jaleco-para-podologo',        titulo: 'Podólogo',        desc: 'CFFa · elastano · postura sentada' },
  { href: '/jaleco-para-psicologa',       titulo: 'Psicólogo',       desc: 'CFP · neutros · setting terapêutico' },
]
...
const SUB_PILAR_LINKS = [
  ...
  { href: '/jaleco-para-farmaceutico',   label: 'Jaleco para Farmacêutico' },
  ...
  { href: '/jaleco-para-veterinario',    label: 'Jaleco para Veterinário' },
  { href: '/jaleco-para-podologo',       label: 'Jaleco para Podólogo' },
  { href: '/jaleco-para-psicologa',      label: 'Jaleco para Psicólogo' },
]
...
export default async function Page() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Uniformes para Saúde', item: 'https://jaleca.com.br/uniformes-profissionais-para-saude' },
    ],
  }
