...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Qual o melhor jaleco para biomédico?', acceptedAnswer: { '@type': 'Answer', text: 'O jaleco para biomédico deve seguir as normas da ANVISA e do CFM. Recomendamos o modelo Profissional com manga longa e tecido com elastano para conforto durante longas horas em laboratório.' } },
    { '@type': 'Question', name: 'Biomédico precisa de jaleco com proteção?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. Em laboratórios, o jaleco funciona como EPI complementar, protegendo contra respingos de reagentes químicos e materiais biológicos.' } },
    { '@type': 'Question', name: 'Qual a cor apropriada para jaleco de biomédico?', acceptedAnswer: { '@type': 'Answer', text: 'O branco é o mais tradicional e higiênico. Facilita a visualização de contaminação e é amplamente aceito em laboratórios clínicos.' } },
    { '@type': 'Question', name: 'O jaleco pode ser lavado em alta temperatura?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. Os jalecos Jaleca suportam lavagem até 60°C, temperatura suficiente para desinfecção em ambiente laboratorial.' } },
    { '@type': 'Question', name: 'Biomédico pode ter jaleco com bordado?', acceptedAnswer: { '@type': 'Answer', text: 'Sim, bordar o nome e número do CRB é prática comum. Para pedidos a partir de 5 peças, oferecemos condições especiais.' } },
  ],
}
