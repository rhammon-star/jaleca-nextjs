...
const faqItems = [
  { q: 'Qual o melhor jaleco para fisioterapeuta?', a: 'O fisioterapeuta precisa de um jaleco que permita total liberdade de movimento. O modelo com elastano é ideal — o tecido retorna à forma após cada alongamento e exercício com o paciente.' },
