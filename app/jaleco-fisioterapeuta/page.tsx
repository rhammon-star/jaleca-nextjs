...
export const metadata: Metadata = {
  title: 'Jaleco para Fisioterapeuta: Tecido Premium, Caimento Perfeito | Jaleca 2026',
...
async function getHeroImage(): Promise<{ src: string; alt: string } | null> {
  try {
    const heroSlug = getHeroImageSlug('fisioterapeuta')
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            >
              Jaleco para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Fisioterapeuta</em>
            </h1>
