...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "O número do CREFITO deve ser bordado no jaleco do fisioterapeuta?", acceptedAnswer: { '@type': 'Answer', text: "Embora não seja uma imposição do conselho, muitos profissionais optam por bordar o CREFITO para identificação. Oferecemos um serviço de bordado preciso e de alta qualidade." } },
    { '@type': 'Question', name: "Qual o tecido ideal para um jaleco de fisioterapeuta que exige flexibilidade e higiene?", acceptedAnswer: { '@type': 'Answer', text: "Indicamos tecidos como o gabardine com elastano ou o brim leve, que proporcionam flexibilidade, são fáceis de higienizar e mantêm a apresentação impecável durante o dia." } },
    { '@type': 'Question', name: "Existem opções de cores modernas para o jaleco do fisioterapeuta além do branco?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos opções em tons claros e neutros como azul claro, cinza ou verde menta, que trazem um toque de modernidade sem comprometer a seriedade profissional. Verifique as normas da sua clínica." } },
    { '@type': 'Question', name: "Como é o corte dos jalecos para fisioterapeutas, pensando na liberdade de movimento?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos possuem cortes ergonômicos e ligeiramente ajustados, permitindo total liberdade de movimento para as diversas técnicas e exercícios da fisioterapia. Conforto e funcionalidade são essenciais." } },
    { '@type': 'Question', name: "Como faço para personalizar meu jaleco com nome e registro do CREFITO?", acceptedAnswer: { '@type': 'Answer', text: "Basta informar seu nome e número de CREFITO no momento da compra. Realizamos o bordado com atenção aos detalhes, garantindo uma identificação clara e duradoura." } },
    { '@type': 'Question', name: "Qual a melhor forma de lavar o jaleco de fisioterapeuta para mantê-lo sempre limpo e higienizado?", acceptedAnswer: { '@type': 'Answer', text: "Lave em água fria com sabão neutro, separadamente de outras roupas. A secagem deve ser feita à sombra para evitar o desgaste do tecido e a perda da cor. A higiene é crucial." } },
    { '@type': 'Question', name: "Qual a durabilidade esperada para um jaleco de fisioterapeuta, considerando o uso intenso?", acceptedAnswer: { '@type': 'Answer', text: "Produzimos jalecos com materiais de alta resistência e costura reforçada, desenhados para suportar o uso diário e as frequentes lavagens sem perder a forma ou a cor." } },
    { '@type': 'Question', name: "Como escolher o tamanho ideal do jaleco para fisioterapeuta, garantindo conforto e caimento?", acceptedAnswer: { '@type': 'Answer', text: "Consulte nossa tabela de medidas e tire suas próprias medidas cuidadosamente. Um jaleco bem ajustado garante conforto e uma aparência profissional durante o atendimento." } },
    { '@type': 'Question', name: "Há diferentes opções de comprimento para o jaleco de fisioterapeuta, pensando na mobilidade?", acceptedAnswer: { '@type': 'Answer', text: "Oferecemos o comprimento clássico, que geralmente vai até a metade da coxa, proporcionando cobertura adequada e não interferindo nos movimentos durante as sessões de tratamento." } },
    { '@type': 'Question', name: "Estão disponíveis modelos de jaleco de fisioterapeuta com manga 3/4 ou curta?", acceptedAnswer: { '@type': 'Answer', text: "Sim, temos opções de manga longa para maior proteção e manga 3/4 ou curta para maior liberdade e conforto em ambientes mais quentes. Escolha o modelo que melhor se adapta à sua rotina." } },
    { '@type': 'Question', name: "Quantos bolsos são práticos em um jaleco de fisioterapeuta e qual a sua distribuição?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos contam com três bolsos: um superior e dois frontais inferiores. São ideais para carregar canetas, olografos ou pequenos acessórios essenciais ao atendimento." } },
    { '@type': 'Question', name: "Qual o estilo dos jalecos para fisioterapeutas para um visual moderno e acolhedor?", acceptedAnswer: { '@type': 'Answer', text: "Priorizamos um estilo contemporâneo e humanizado, com linhas limpas e detalhes que transmitem profissionalismo e confiança, sem abrir mão da praticidade e do conforto." } },
    { '@type': 'Question', name: "Qual a principal diferença entre um jaleco de fisioterapeuta e um jaleco médico tradicional?", acceptedAnswer: { '@type': 'Answer', text: "O jaleco de fisioterapeuta é projetado com ênfase em mobilidade e flexibilidade do tecido, ideal para movimentos corporais durante os exercícios. O jaleco médico foca mais em proteção e formalidade." } },
    { '@type': 'Question', name: "É possível personalizar os jalecos com o logo da minha clínica de fisioterapia?", acceptedAnswer: { '@type': 'Answer', text: "Sim, oferecemos o serviço de bordado do logo da sua clínica para pedidos corporativos. É uma excelente forma de padronizar sua equipe e fortalecer a identidade da sua marca." } },
    { '@type': 'Question', name: "Qual o preço médio de um jaleco de fisioterapeuta com personalização?", acceptedAnswer: { '@type': 'Answer', text: "Nossos jalecos de fisioterapeuta iniciam a partir de R$ 110,00, com a opção de bordado incluída. Os valores podem variar conforme o modelo e tecido escolhido." } },
    { '@type': 'Question', name: "Qual o prazo de entrega para jalecos de fisioterapeuta com bordado do nome e CREFITO?", acceptedAnswer: { '@type': 'Answer', text: "O prazo de entrega para jalecos personalizados é de 7 a 15 dias úteis, contabilizando o tempo de produção e o frete. Você receberá atualizações sobre o status do seu pedido." } },
    { '@type': 'Question', name: "Como funciona a política de troca caso o jaleco de fisioterapeuta não vista bem?", acceptedAnswer: { '@type': 'Answer', text: "Aceitamos trocas em até 7 dias após o recebimento, desde que o jaleco esteja sem uso. Para produtos com bordado personalizado, aplicam-se condições específicas, consulte-nos." } },
    { '@type': 'Question', name: "Há ofertas de frete grátis para jalecos de fisioterapeuta em alguma situação?", acceptedAnswer: { '@type': 'Answer', text: "Sim, periodicamente lançamos promoções de frete grátis para compras acima de determinado valor ou para regiões específicas. Fique atento aos nossos anúncios no site." } },
    { '@type': 'Question', name: "Os jalecos de fisioterapeuta possuem alguma garantia de satisfação ou contra defeitos?", acceptedAnswer: { '@type': 'Answer', text: "Todos os nossos jalecos vêm com uma garantia de 90 dias contra defeitos de fabricação. Sua satisfação e a qualidade de nossos produtos são a nossa prioridade." } },
    { '@type': 'Question', name: "Os tecidos utilizados nos jalecos de fisioterapeuta são fáceis de passar e manter?", acceptedAnswer: { '@type': 'Answer', text: "Sim, selecionamos tecidos que amassam pouco, facilitando a manutenção e garantindo que seu jaleco esteja sempre impecável com o mínimo de esforço. Praticidade para o dia a dia." } },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Fisioterapeuta', item: 'https://jaleca.com.br/jaleco-fisioterapeuta' },
  ],
}
...
export default async function JalecoDentistaPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    ...
    getGooglePlaceData(),
    getCachedHeroImage(getHeroImageSlug('fisioterapeuta') ?? ''),
  ])
  ...
  return (
    <>
      ...
      {(() => { const s = buildHowToSchema('jaleco-fisioterapeuta', 'https://jaleca.com.br/jaleco-fisioterapeuta'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const s = buildOccupationSchema('jaleco-fisioterapeuta', 'https://jaleca.com.br/jaleco-fisioterapeuta'); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const s = buildItemListSchema(produtos, 'https://jaleca.com.br/jaleco-fisioterapeuta', "Jalecos para fisioterapeuta"); return s ? <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} /> : null })()}
      {(() => { const arr = buildProductListSchema(produtos, 'https://jaleca.com.br/jaleco-fisioterapeuta'); return arr ? arr.map((s, i) => <script key={'p'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      {(() => { const arr = buildReviewSchema(placeData?.reviews, 'https://jaleca.com.br/jaleco-fisioterapeuta', "Jaleco para fisioterapeuta", produtos); return arr ? arr.map((s, i) => <script key={'r'+i} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(s).replace(/</g, '\\u003c') }} />) : null })()}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        <div style={{ background: '#f9f7f4', borderBottom: '1px solid #e5e0d8', padding: '0.85rem clamp(1.5rem,5vw,4rem)' }}>
          <ol className="flex items-center gap-2 max-w-[1200px] mx-auto" style={{ listStyle: 'none' }}>
            {[
              ...
              { label: 'Para Fisioterapeuta', href: null },
            ].map((crumb, i, arr) => (
          ...
          <section id="produtos" className="px-4 py-12 lg:px-16 lg:py-20" style={{ background: '#f9f7f4', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
            <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
              <div className="mb-10">
                <div>
                  ...
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Jalecos para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Fisioterapeutas</em>
                  </h2>
                </div>
                </div>
              ...
              <div className="flex justify-center mt-8">
                <Link href={getVerMaisUrl('fisioterapeuta')} style={{ display: 'inline-flex', padding: '0.9rem 2rem', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a', color: '#1a1a1a' }}>
                  Ver mais →
                </Link>
              </div>
            </div>
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre jaleco<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>para fisioterapeuta</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
        ...
        <section style={{ background: '#f9f7f4', padding: 'clamp(5rem,10vw,9rem) clamp(1.5rem,5vw,4rem)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <EATBlock profession="fisioterapeuta" />
