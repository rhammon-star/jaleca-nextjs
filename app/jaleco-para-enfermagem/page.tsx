...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-enfermagem' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-enfermagem',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Enfermagem', item: 'https://jaleca.com.br/jaleco-para-enfermagem' },
  ],
}
...
async function getBlogPosts(): Promise<WPPost[]> {
  try {
    const posts = await getPosts({ per_page: 3, search: 'enfermagem' })
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '1rem', fontWeight: 300, color: '#6b6b6b', maxWidth: 420, marginBottom: '2.5rem', lineHeight: 1.8 }}>
              Conforto e mobilidade para a rotina hospitalar. Tecido premium com elastano, Bolsos funcionais.
            </p>
