...
const schemaFaq = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'Qual comprimento de jaleco é mais indicado para enfermeiro(a)s?', acceptedAnswer: { '@type': 'Answer', text: 'Para enfermagem, o jaleco médio — permite mobilidade e atende os padrões hospitalares.' } },
    ...
    { '@type': 'Question', name: 'Jaleco com elastano é bom para enfermeiro(a)?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. O elastano adiciona memória ao tecido, retornando à forma após o movimento — essencial para quem passa horas em atendimento.' } },
    { '@type': 'Question', name: 'Jaleco de enfermeiro(a) precisa ser branco?', acceptedAnswer: { '@type': 'Answer', text: 'Não é obrigação. O branco é o clássico, mas tons pastel e cores discretas são bem aceitos. O COFEN não restringe a cor.' } },
...
const schemaArticle = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'Scrub Enfermagem: Conjunto Pijama Cirúrgico Premium | Jaleca',
  description: 'Scrub para Enfermagem em tecido respirável com elastano. Conjunto blusa + calça do PP ao G3. Frete grátis SP/RJ/MG/ES. Jaleca.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Scrub Enfermagem', item: 'https://jaleca.com.br/scrub-enfermagem' },
  ],
}
...
export default async function ScrubEnfermagemPage() {
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        <div style={{ background: '#f9f7f4', borderBottom: '1px solid #e5e0d8', padding: '0.85rem clamp(1.5rem,5vw,4rem)' }}>
          <ol className="flex items-center gap-2 max-w-[1200px] mx-auto" style={{ listStyle: 'none' }}>
            {[
              ...
              { label: 'Scrub Enfermagem', href: null },
            ].map((crumb, i, arr) => (
        ...
        >
          ...
          >
            ...
            >
              Scrub para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Enfermagem</em>
            </h1>
            <p style={{ fontSize: '1rem', fontWeight: 300, color: '#6b6b6b', maxWidth: 420, marginBottom: '2.5rem', lineHeight: 1.8 }}>
              Conjunto pijama cirúrgico em tecido respirável. Conforto e movimento livre para o ritmo da enfermagem.
            </p>
            <div className="flex gap-4 flex-wrap">
              ...
              <Link href="/produtos?categoria=conjuntos-masculinos" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.9rem 2rem', background: 'transparent', color: '#1a1a1a', fontSize: '0.78rem', fontWeight: 400, letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid #1a1a1a' }}>
                Masculino →
              </Link>
            </div>
              ...
              <div className="flex justify-between items-end flex-wrap gap-4 mb-10">
                <div>
                  ...
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Scrubs para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Enfermagem</em>
                  </h2>
                </div>
            ...
            <div className="grid" style={{ gridTemplateColumns: '280px 1fr', gap: 'clamp(3rem,6vw,6rem)', alignItems: 'start' }}>
                ...
                <nav>
                  <ul style={{ listStyle: 'none' }}>
                    {[
                      ...
                      { label: 'Normas do COFEN', anchor: '#cofen' },
                    ].map(item => (
              ...
              <article>
                {[
                    ...
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Jaleco de enfermeiro(a) aguenta muita lavagem e mancha. Precisa ser confortável por horas.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  {
                    id: 'cores',
                    title: 'Jaleco branco ou colorido: o que o COFEN diz',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O branco é o clássico, claro. Mas o COFEN não restringe cores.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                  ...
                  {
                    id: 'cro',
                    title: 'Normas do COFEN sobre vestimenta profissional',
                    body: (
                      <>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          O COFEN, junto com a ANVISA, exige: use o jaleco só no trabalho. Nunca em transporte ou fora da clínica. A peça precisa estar sempre limpa e em bom estado.
                        </p>
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
        ...
        <section style={{ background: '#fff', padding: 'clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
              Perguntas sobre<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Enfermagem</em>
            </h2>
            <FaqAccordion />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3" style={{ gap: '2px', background: '#e5e0d8', marginTop: '3rem' }}>
              {posts.length > 0 ? posts.map(post => {
                ...
                [
                  ...
                  { title: 'Jaleco branco: tradição e protocolos em enfermagem', href: '/blog', tag: 'Enfermagem', excerpt: 'Por que o branco é tão usado em enfermagem e o que recomendam sobre cores e vestimenta.' },
