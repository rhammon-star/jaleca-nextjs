...
const schemaFaq = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'A Jaleca oferece garantia nos produtos?', acceptedAnswer: { '@type': 'Answer', text: 'Arrependimento: 7 dias após o recebimento (CDC Art. 49). Para defeito de fabricação, os prazos seguem o Código de Defesa do Consumidor (30 ou 90 dias). Assistimos pós-venda para defeitos identificados.' } },
          ...
          <section className="mt-14">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: 'A Jaleca oferece garantia?', a: 'Arrependimento: 7 dias após o recebimento (CDC). Para defeito de fabricação, os prazos seguem o Código de Defesa do Consumidor (30 ou 90 dias).' },
