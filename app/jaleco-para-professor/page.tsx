...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-professor' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-professor',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Professor', item: 'https://jaleca.com.br/jaleco-para-professor' },
  ],
}
