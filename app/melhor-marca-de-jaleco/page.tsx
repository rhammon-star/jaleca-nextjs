...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/melhor-marca-de-jaleco' },
  openGraph: {
    title: 'Melhor Marca de Jaleco em 2026: Qual Escolher? | Jaleca',
    ...
    url: 'https://jaleca.com.br/melhor-marca-de-jaleco',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
export default async function Page() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Melhor Marca de Jaleco', item: 'https://jaleca.com.br/melhor-marca-de-jaleco' },
    ],
  }
