...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/loja-de-jaleco' },
  openGraph: {
    title: 'Loja de Jaleco Online — Jalecos para Profissionais | Jaleca',
...
const CATEGORIAS = [
  ...
  { href: '/jaleco-para-medico', label: 'Jaleco para Médico', sub: 'Gabardine, manga longa, bolsos laterais' },
  { href: '/jaleco-para-dentista', label: 'Jaleco para Dentista', sub: 'Com fechamento adequado e mobilidade' },
  { href: '/jaleco-para-esteticista', label: 'Jaleco para Esteticista', sub: 'Cores, tecidos específicos para estética' },
  { href: '/jaleco-para-cabeleireiro', label: 'Jaleco para Cabeleireiro', sub: 'Repele fios, lavagem frequente' },
...
export default async function Page() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Loja de Jaleco', item: 'https://jaleca.com.br/loja-de-jaleco' },
    ],
  }
