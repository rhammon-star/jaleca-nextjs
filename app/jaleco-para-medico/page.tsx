...
export const metadata: Metadata = {
  title: 'Jaleco para Médico: Tecido Premium, Caimento Perfeito | Jaleca 2026',
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-medico' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-medico',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Médico', item: 'https://jaleca.com.br/jaleco-para-medico' },
  ],
}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            >
              Jaleco para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Médico</em>
            </h1>
