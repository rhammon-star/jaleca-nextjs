...
export const metadata: Metadata = {
  title: 'Jaleco para Podólogo: Tecido Premium, Caimento Perfeito | Jaleca 2026',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Podólogo', item: 'https://jaleca.com.br/jaleco-para-podologo' },
  ],
}
      ...
      <main style={{ fontWeight: 300 }}>
        ...
        >
          ...
          >
            ...
            >
              Jaleco para<br />
              <em style={{ fontStyle: 'italic', fontWeight: 300 }}>Podólogo</em>
            </h1>
