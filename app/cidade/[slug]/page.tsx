...
const CIDADES: Record<string, CidadeInfo> = {
  ...
  'jaleco-caratinga': {
    ...
    uf: 'MG',
    tipo: 'fechada',
    profissoes: 'médicos, dentistas, enfermeiros e profissionais de saúde de Caratinga',
    freteGratis: true,
    conteudoLocal: 'Profissionais de saúde em Caratinga, MG, encontram na Jaleca jalecos com design moderno, tecido de qualidade e entrega rápida. Atendemos médicas, dentistas e enfermeiras da cidade com frete grátis para MG acima de R$499.',
  },
  'jaleco-contagem': {
    nome: 'Contagem',
    estado: 'Minas Gerais',
