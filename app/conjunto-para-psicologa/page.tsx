...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/conjunto-para-psicologa' },
  openGraph: {
    title: 'Conjunto Profissional para Psicóloga | Jaleca',
    description: 'Uniforme profissional completo para psicólogas. Tecido premium, caimento impecável, preço justo. Do PP ao G3.',
    url: 'https://jaleca.com.br/conjunto-para-psicologa',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Psicóloga', item: 'https://jaleca.com.br/conjunto-para-psicologa' },
  ],
}
