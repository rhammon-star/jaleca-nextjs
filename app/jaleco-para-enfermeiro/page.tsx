...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-enfermeiro' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-enfermeiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Jaleco para Enfermeiro', item: 'https://jaleca.com.br/jaleco-para-enfermeiro' },
  ],
}
