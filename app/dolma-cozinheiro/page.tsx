...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://jaleca.com.br/dolma-cozinheiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Cozinheiro', item: 'https://jaleca.com.br/dolma-cozinheiro' },
  ],
}
...
export default async function DolmaCozinheiroPage() {
  const [produtos, posts, placeData, heroImg] = await Promise.all([
    getDólmãs(),
    getCachedBlogPosts('cozinha profissional'),
    getGooglePlaceData(),
    getCachedHeroImage(getHeroImageSlug('cozinheiro') ?? ''),
  ])
              ...
              <div className="flex justify-between items-end flex-wrap gap-4 mb-10">
                <div>
                  ...
                  <h2 style={{ fontFamily: "'Cormorant', Georgia, serif", fontSize: 'clamp(2rem,3.5vw,3rem)', fontWeight: 400, lineHeight: 1.15, color: '#1a1a1a' }}>
                    Dólmãs para<br /><em style={{ fontStyle: 'italic', fontWeight: 300 }}>Cozinheiros</em>
                  </h2>
                </div>
                ...
                {[
                  {
                    ...
                    body: (
                      <>
                        ...
                        <p style={{ fontSize: '0.97rem', color: '#444', lineHeight: 1.85, marginBottom: '1.2rem', fontWeight: 300 }}>
                          Na Jaleca, as dólmãs têm elastano e tratamento antipeling, o que significa que resistem a manchas de gordura e mantêm a aparência mesmo após múltiplas lavagens.
                        </p>
          ...
          <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
              {[
                ...
                { label: 'Sushiman', href: '/dolma-sushiman', desc: 'Guia completo' },
