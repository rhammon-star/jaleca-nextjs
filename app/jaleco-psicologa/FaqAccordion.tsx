...
const faqItems = [
  { q: 'Qual o melhor jaleco para psicólogo?', a: 'O psicólogo pode usar jaleco em consultório para transmitir profissionalismo. O modelo com elastano é confortável para longas sessões. Cores suaves são amplamente aceitas na área.' },
