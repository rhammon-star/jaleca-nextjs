...
const faqItems = [
  ...
  { q: 'A Jaleca borda o nome e CRM no jaleco?', a: 'A Jaleca não oferece serviço de bordado. O jaleco é vendido sem bordado. Você pode levar a peça a uma bordadeira local após receber — é simples e acessível. Importante: após o bordado, o jaleco não pode mais ser trocado.' },
