...
const schemaFaq = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Jaleco com elastano é bom para veterinário?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. O elastano adiciona memória ao tecido, retornando à forma após o movimento — essencial para quem passa horas com braços elevados.' } },
