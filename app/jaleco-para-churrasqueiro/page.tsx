...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://jaleca.com.br/jaleco-para-churrasqueiro' },
  openGraph: {
    ...
    url: 'https://jaleca.com.br/jaleco-para-churrasqueiro',
    siteName: 'Jaleca',
    locale: 'pt_BR',
    type: 'article',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Para Churrasqueiro', item: 'https://jaleca.com.br/jaleco-para-churrasqueiro' },
  ],
}
