...
- **Microsoft Ads UET**: evento Purchase único via `PurchaseTracker.tsx` (`app/pedido-confirmado/[orderId]/PurchaseTracker.tsx`); removido bloco duplicado de `app/pagamento/page.tsx`.
