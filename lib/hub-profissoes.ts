...
export const CLUSTER_LINKS: Record<string, Array<{ label: string; href: string; desc: string }>> = {
  saude: [
    { label: '← Uniformes para Saúde', href: '/uniformes-profissionais-saude', desc: 'Guia completo da área' },
  ...
  beleza: [
    { label: 'Barbeiro', href: '/jaleco-barbeiro', desc: 'Guia completo' },
  ...
  gastronomia: [
    { label: 'Churrasqueiro', href: '/jaleco-churrasqueiro', desc: 'Jaleco' },
    { label: 'Sushiman', href: '/jaleco-sushiman', desc: 'Jaleco' },
    { label: 'Cozinheiro', href: '/dolma-cozinheiro', desc: 'Dólmã' },
    { label: 'Dólmã Churrasqueiro', href: '/dolma-churrasqueiro', desc: 'Dólmã' },
    { label: 'Dólmã Sushiman', href: '/dolma-sushiman', desc: 'Dólmã' },
    { label: 'Dólmã Cozinheiro', href: '/dolma-cozinheiro', desc: 'Dólmã' },
  ],
  servicos: [
    { label: 'Professor', href: '/jaleco-professor', desc: 'Guia completo' },
    { label: 'Vendedor', href: '/jaleco-vendedor', desc: 'Guia completo' },
    { label: 'Universitário', href: '/jaleco-universitario', desc: 'Jaleco aluno' },
    { label: 'Dona de Casa', href: '/jaleco-dona-casa', desc: 'Jaleco prático' },
    { label: 'Uniforme Professor', href: '/uniforme-professor', desc: 'Guia completo' },
  ],
  escritorio: [
    { label: 'Advogado', href: '/jaleco-advogado', desc: 'Jaleco' },
    { label: 'Pastor', href: '/jaleco-pastor', desc: 'Jaleco' },
    { label: 'Psicólogo', href: '/jaleco-psicologa', desc: 'Jaleco' },
...
export const HUB_PROFISSOES: HubProfissao[] = [
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Dentista: NR-32 e Modelo Certo | Jaleca',
      description:
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Podólogo: Elastano e Conforto | Jaleca',
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Biomédico: Lab e Harmonização | Jaleca',
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Enfermeiro: COFEN e Lavagem 60°C | Jaleca',
    ...
    faq: [
      ...
      { q: 'Como funciona a troca de tamanho?', a: 'Arrependimento: até 7 dias após o recebimento, produto sem uso e com etiqueta (CDC). Para defeito de fabricação, os prazos seguem o Código de Defesa do Consumidor (30 ou 90 dias). Entre em contato pelo WhatsApp.' },
      { q: 'Qual o prazo de entrega?', a: 'Enviamos em até 2 dias úteis. Capitais do Sudeste recebem em 3 a 5 dias úteis.' },
    ],
    cta: { descricao: 'Do PP ao G3. Elastano para total conforto. 12 cores. Frete grátis no Sudeste acima de R$499.' },
  dateModified: '2026-04-21',
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Fisioterapeuta: RPG, Pilates e Movimento | Jaleca',
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Nutricionista: Autoridade no Consultório | Jaleca',
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Veterinário: Guia Completo | Jaleca',
...

  {
    ...
    cluster: 'saude',
    metadata: {
      title: 'Jaleco para Médico: Telemedicina e Consultório | Jaleca',
...

  {
    ...
    cluster: 'beleza',
    metadata: {
      title: 'Jaleco para Barbeiro: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'beleza',
    metadata: {
      title: 'Jaleco para Tatuador: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'gastronomia',
    metadata: {
      title: 'Jaleco para Churrasqueiro: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'gastronomia',
    metadata: {
      title: 'Jaleco para Cozinheiro: Tecido Premium, Conforto na Cozinha | Jaleca',
...

  {
    ...
    faq: [
      ...
      { q: 'Como funciona a troca?', a: 'Arrependimento: até 7 dias após o recebimento, produto sem uso e com etiqueta (CDC). Para defeito de fabricação, os prazos seguem o Código de Defesa do Consumidor (30 ou 90 dias). Entre em contato pelo WhatsApp.' },
      { q: 'Qual o prazo de entrega?', a: 'Enviamos em até 2 dias úteis. Capitais do Sudeste recebem em 3 a 5 dias úteis.' },
    ],
...

  {
    ...
    cluster: 'escritorio',
    metadata: {
      title: 'Jaleco para Advogado: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'escritorio',
    metadata: {
      title: 'Jaleco para Pastor: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'escritorio',
    metadata: {
      title: 'Jaleco para Farmacêutico: Normas, RDC 67 e Manga Longa | Jaleca',
...

  {
    ...
    cluster: 'gastronomia',
    produto: 'dolma',
    urlSlug: 'dolma-churrasqueiro',
    metadata: {
      title: 'Dólmã para Churrasqueiro: Uniforme Completo | Jaleca',
...

  {
    ...
    cluster: 'gastronomia',
    produto: 'dolma',
    urlSlug: 'dolma-sushiman',
    metadata: {
      title: 'Dólmã para Sushiman: Guia Completo | Jaleca',
...

  {
    ...
    cluster: 'gastronomia',
    produto: 'dolma',
    urlSlug: 'dolma-cozinheiro',
    metadata: {
      title: 'Dólmã para Cozinheiro: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'escritorio',
    produto: 'conjunto',
    urlSlug: 'conjunto-advogado',
    metadata: {
      title: 'Conjunto para Advogado: Guia Completo | Jaleca',
...

  {
    ...
    cluster: 'escritorio',
    produto: 'conjunto',
    urlSlug: 'conjunto-psicologa',
    metadata: {
      title: 'Conjunto para Psicólogo: Guia Completo | Jaleca',
...

  {
    ...
    cluster: 'escritorio',
    produto: 'conjunto',
    urlSlug: 'conjunto-farmaceutico',
    metadata: {
      title: 'Conjunto para Farmacêutico: Guia Completo | Jaleca',
...

  {
    ...
    cluster: 'servicos',
    produto: 'jaleco',
    urlSlug: 'uniforme-professor',
    metadata: {
      title: 'Jaleco para Professor: Jaleco Escola e Laboratório | Jaleca',
...

  {
    ...
    cluster: 'escritorio',
    produto: 'conjunto',
    urlSlug: 'jaleco-secretaria',
    metadata: {
      title: 'Conjunto para Secretária: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    metadata: {
      title: 'Jaleco para Universitário: Tecido Premium, Caimento Perfeito | Jaleca',
...

  {
    ...
    cluster: 'servicos',
    produto: 'jaleco',
    urlSlug: 'jaleco-dona-casa',
    metadata: {
      title: 'Jaleco para Dona de Casa: Tecido Premium, Caimento Perfeito | Jaleca',
